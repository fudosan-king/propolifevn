    ...
    <ul class="fullwidth">
        <?php if(current_lang_() == 'vn'){?>
            <li>
             ...
             <li>
                <a href="<?=create_url(); ?>page/ローカルサービスアパートメント・アパートメントのご紹介"><?php echo lang('ホーチミンの住居について'); ?></a>
            </li>
             <li>
            ...
            <li>
             ...
             <li>
                <a href="<?=create_url(); ?>page/進出支援のご案内"><?php echo lang('会社設立・進出支援のご案内'); ?></a>
            </li>
             <li>
                <a href="<?=create_url(); ?>page/ベトナム ホーチミン 内装工事 オフィス店舗デザイン・設計施工"><?php echo lang('オフィス内装工事のご案内'); ?></a>
            </li>
        <?php } else { ?>
            <li>
                <a href="<?=create_url(); ?>page/短期アパートのご案内"><?php echo lang('短期アパートのご案内'); ?></a>
