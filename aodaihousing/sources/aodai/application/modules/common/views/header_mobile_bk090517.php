            ...
            <div class="nav-custom">
                <div class="nav-res"> 
                    <ul>
                        ...
                        <a href="<?=create_url(); ?>page/ベトナムビザ">
                            <li class="menu-consult-visa <?php if($this->uri->segment(3)=='ベトナムビザ') echo 'active' ?>"><?php echo lang('ビザの取得を相談する'); ?></li></a>
                            <!-- <?=create_url(); ?>page/ベトナムビザ -->
                        ...
                        <a href="<?=create_url(); ?>page/ベトナムビザ">
                            <li class="menu-consult-visa <?php if($this->uri->segment(2)=='ベトナムビザ') echo 'active' ?>"><?php echo lang('ビザの取得を相談する'); ?></li></a>
                            <!-- <?=create_url(); ?>page/ベトナムビザ -->
