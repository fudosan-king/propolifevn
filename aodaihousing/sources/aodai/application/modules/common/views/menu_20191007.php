...
<div class="menu">
    <div class="menu-item">
        <ul>
            ...
            <li class="<?=$page_261; ?><?=$page_258; ?><?=$page_269; ?><?=$page_272; ?><?=$page_273; ?><?=$page_274; ?><?=$page_design_interior; ?> <?=$page_case_construction?> <?=$page_after_sales_service; ?> <?=$page_interior_furniture;?>  <?=$page_vitalify;?>  <?=$page_regal;?>  <?=$page_fanuc;?> <?=$page_interior_construction; ?>">
                ...
                <ol class="sub-menu sub-1 sub-1-4">
                   ...
                   <li><a class="<?=$page_272; ?>" href="<?=create_url(); ?>page/オルグロー・ラボ（AllGrowLabo Co.,Ltd.）様"><span>施行事例⑧</span></a></li> 
                   <li><a class="<?=$page_273; ?>" href="<?=create_url(); ?>page/リーガル（REGAL）様"><span>施行事例⑨</span></a></li> 
            ...
            <li <?php if($this->uri->segment(2)=='WEB広告をしたい' || $this->uri->segment(3)=='WEB広告をしたい'){ print 'class="active"'; } ?>>
                ...
                <ol class="sub-menu">
                    ...
                    <li><a target="_blank" href="https://www.propolifevietnam.com/webサイト制作.html/"><span>WEBサイト制作</span></a></li>
