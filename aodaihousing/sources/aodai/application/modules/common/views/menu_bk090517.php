        ...
        <ul>
            ...
            <li class="<?=$page_incorporation; ?> <?=$page_workshops_home;?> <?=$page_industrial; ?> <?=$page_advanced_support?> <?=$page_support_content?> <?=$page_work_permits; ?>  <?=$page_vietnam_work_permits; ?> <?=$page_suport_vn; ?> <?=$page_find_industrial; ?> <?=$page_clothing_manufacturer; ?> <?=$page_human_resources_consulting; ?> <?=$page_interior_equipment_manufacturers; ?> <?=$page_gym_management; ?>">
                ...
                <ol class="sub-menu">
                    ...
                    <li>
                        <a class="<?=$page_work_permits; ?>" href="<?=create_url(); ?>page/ベトナムビザ"><span><?php echo lang("ベトナムビザ") ?> </span></a>
                    </li>
