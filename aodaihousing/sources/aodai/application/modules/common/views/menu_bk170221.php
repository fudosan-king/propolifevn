...
<div class="menu">
    <div class="menu-item">
        <ul>
            ...
            <li class="<?=$page_259; ?> <?=$page_short_term_apartment; ?> <?=$page_office_information?> <?=$page_guidance_industrial_factory?> <?=$page_guidance_stores?> <?=$page_popular_apartment?> <?=$page_serviced_apartments?> <?=$cateory_183?> <?=$cateory_184?> <?=$page_aodai_support;?> <?=$page_contracting_process;?> <?=$page_register_home; ?>">
                ...
                <ol class="sub-menu sub-1 sub-1-2">
                    ...
                    <li><a class="<?=$page_259;?>" href="<?=create_url(); ?>page/ローカルサービスアパートメント・アパートメントのご紹介" class="last-child"><span><?php echo change_language("アパートのご案内","アパートのご案内") ?></span></a></li>

                    <li><a class="<?=$page_short_term_apartment;?>" href="<?=create_url(); ?>page/短期アパートのご案内" class="last-child"><span style="letter-spacing: -0.7px !important;"><?php echo change_language("短期アパートのご案内","短期アパートのご案内") ?></span></a></li>

                    <li><a class="<?=$page_office_information;?>" href="<?=create_url(); ?>page/オフィスのご案内" class="last-child"><span><?php echo change_language("オフィスのご案内","オフィスのご案内") ?></span></a></li>
                    ...
                    <li><a class="<?=$page_aodai_support;?>" href="<?=create_url(); ?>page/アオザイサポートデスク" class="last-child"><span><?php echo "サポートデスク"; ?></span></a></li>
            ...
            <li class="<?=$page_incorporation; ?> <?=$page_workshops_home;?> <?=$page_industrial; ?> <?=$page_advanced_support?> <?=$page_support_content?> <?=$page_work_permits; ?> <?=$page_suport_vn; ?> <?=$page_find_industrial; ?> <?=$page_clothing_manufacturer; ?> <?=$page_human_resources_consulting; ?> <?=$page_interior_equipment_manufacturers; ?> <?=$page_gym_management; ?>">
                <a href="#"><span><?=change_language('ベトナムへ進出したい','Có nhu cầu lập nghiệp tại Việt Nam')?></span></a>
                <ol class="sub-menu">
                    <li><a class="<?=$page_advanced_support?>" href="<?=create_url(); ?>page/進出支援のご案内"><span><?php echo change_language('ベトナム進出支援', 'ベトナム進出支援') ?></span></a></li>
                    ...
                    <li><a class="<?=$page_work_permits; ?>" href="<?=create_url(); ?>page/ベトナムビザ・労働許可証"><span><?php echo lang("ビザ・労働許可証取得") ?> </span></a></li>
            ...
            <li class="<?=$page_261; ?><?=$page_258; ?><?=$page_269; ?><?=$page_design_interior; ?> <?=$page_case_construction?> <?=$page_after_sales_service; ?> <?=$page_interior_furniture;?>  <?=$page_vitalify;?>  <?=$page_regal;?>  <?=$page_fanuc;?> <?=$page_interior_construction; ?>">
                <a href="#"><span><?php echo change_language('内装工事をしたい', 'Thiết kế và lắp đặt nội thất') ?></span></a>
                <ol class="sub-menu sub-1 sub-1-4">
                   <li><a class="<?=$page_design_interior; ?>" href="<?=create_url(); ?>page/ベトナム ホーチミン 内装工事 オフィス店舗デザイン・設計施工"><span> オフィス・店舗</span></a></li>
            ...
            <li <?php if($this->uri->segment(2)=='WEB広告をしたい' || $this->uri->segment(3)=='WEB広告をしたい'){ print 'class="active"'; } ?>>
                <a href="<?=create_url(); ?>page/WEB広告をしたい"><span style="letter-spacing: -0.5px !important;">WEB制作・オフショア</span></a>
                <ol class="sub-menu">
                    <li><a target="_blank" href="http://www.propolifevietnam.com/web-step.html"><span>サービスについて</span></a></li>

                    <li><a target="_blank" href="http://www.propolifevietnam.com/web.html"><span>WEBサイト制作</span></a></li>

                    <li><a target="_blank" href="http://www.propolifevietnam.com/development.html"><span>オフショア開発</span></a></li>
                </ol>
            </li>

            <li class="<?=$page_about; ?> <?=$page_staff_introduction; ?> <?=$page_jobs; ?>">
                <a href="#"><span><?php echo lang("会社案内") ?></span></a>
                <ol class="sub-menu">
                    <li><a class="<?=$page_about; ?>" href="<?=create_url(); ?>page/プロポライフベトナム 会社概要"><span>会社概要</span></a></li>
