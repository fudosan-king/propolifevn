...
<div class="apartment-info">
    <div class="name name-width-33"><p><span class="label"><?php echo lang('タイプ') ?>:</span> <?=$data_type[$item->type];?></p></div>
    ...
    <div class="list-left">
        <div class="list-left-table">
            <?php if(vcp_printf($item->name_jp, current_lang_()) == ""){?>
                <a href="<?=PATH_URL?>vn/houses/detail/<?= $item->id . '/' .vcp_printf($item->name_en)?>">
            <?php }else{ ?>
    ...
    <div class="list-right">
        <div class="rent">
            ...
            <div class="w-2">
                <div><p><span class="label"><?php echo lang('rent'); ?>:</span> <?=vcp_printf($item->rent, current_lang_()); ?> USD</p></div>
            ...
            <div class="w-2 w-right"><p><span class="label"><?php echo lang('間取り'); ?>:</span> <?=vcp_printf($item->house_layouts, current_lang_());?></p></div>
        </div>
        ...
        <div class="floor">
            ...
            <?php if(vcp_printf($item->name_jp, current_lang_()) == ""){?>
                <a href="<?=PATH_URL?>vn/houses/detail/<?= $item->id . '/' .vcp_printf($item->name_en)?>"><p><?php echo lang('詳しく見る'); ?></p></a>
            <?php }else{ ?>
                <a href="<?=create_url("houses/detail/" . $item->id . '/' . vcp_printf($item->name_en, current_lang_()));?>"><p><?php echo lang('詳しく見る'); ?></p></a>    
            <?php } ?>
            </div>
        </div>
    </div>
...
<!-- <div class="paging">
    <img src="<?=PATH_URL_IMAGES.'static/images/aodai_mobile/'?>circle1.png" class="img-responsive">
    <img src="<?=PATH_URL_IMAGES.'static/images/aodai_mobile/'?>circle1.png" class="img-responsive">
    <img src="<?=PATH_URL_IMAGES.'static/images/aodai_mobile/'?>circle1.png" class="img-responsive">
    <img src="<?=PATH_URL_IMAGES.'static/images/aodai_mobile/'?>circle1.png" class="img-responsive">
    <img src="<?=PATH_URL_IMAGES.'static/images/aodai_mobile/'?>circle1.png" class="img-responsive">
