...
class Contact extends MX_Controller {
    ...
    public function sendMail($data)
    {
        ...
        if (!searchValueInArray($bcc_list, 'email', 'm.watanabe@aodaihousing.com')) {
        	$bcc_list['m.watanabe@aodaihousing.com'] = array('name'=>'m.watanabe', 'email'=> 'm.watanabe@aodaihousing.com');
        }

        if (!searchValueInArray($bcc_list, 'email', 'ebuchi@propolifevietnam.com')) {
        	$bcc_list['ebuchi@propolifevietnam.com'] = array('name'=>'ebuchi', 'email'=> 'ebuchi@propolifevietnam.com');
        }
