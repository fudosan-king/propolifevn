...
<head>
   ...
   <script>
    ...
    dataLayer.push({'event': 'inquiry-initial'});</script>
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-KRT7X7"
height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
            ...
            <div class="input-wrap">
                <table width="742" border="0">
                  ...
                  <tr>
                    ...
                    <td><span class="input-text"><input type="text" name="email" id="textfield" placeholder="info@propolifevietnam.com" value="<?=isset($email)?$email:'';?>"/></span></td>
                  </tr>
                  <tr>
