...
<div class="table">
    ...
    <div class="row_text_field">
		<table cellspacing="0" cellpadding="0" border="0" width="100%">
			<tr>
				<td class="left_text_field">Location:</td>
    ...
    <link rel="stylesheet" href="<?=PATH_URL.'static/css/chosen/'?>chosen.css" type="text/css"/>
    
    <script type="text/javascript" src="<?=PATH_URL.'static/css/chosen/chosen.jquery.js'?>"></script>
     <script type="text/javascript"> 
