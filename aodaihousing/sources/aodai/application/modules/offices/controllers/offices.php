...
class Offices extends MX_Controller {
    ...
    public function admincp_upload(){
        ...
        if (move_uploaded_file($_FILES['uploadfile']['tmp_name'], $path_file)) { 
          echo '<li><a href="#" title=""><img width="101" height="101" src="'.PATH_URL_IMAGES.'static/uploads/offices/gallery/'.$file.'" alt=""></a>
                        <div class="actions" style="display: none;">
                            <a href="#" title=""><img src="'.PATH_URL_IMAGES.'static/images/admin/icons/edit.png" alt=""></a>
                            <a href="#" title=""><img src="'.PATH_URL_IMAGES.'static/images/admin/icons/delete.png" alt=""></a>
                        </div>
...
//        getToolbar($this->module, $toolBar);
    ...
    public function detail() {
        ...
        if(is_numeric($id) == false) {
            ...
            $thumb = empty($item->images_thumb)? $this->config->item('image'):PATH_URL_IMAGES . 'static/uploads/offices/' . $item->images_thumb;;
            $seoGoogle = array(
    ...
    public function slide($items,$thumb = ''){
        $data = array(
            'items' =>$items,
            'thumb' => $thumb
        );
