...
<div id="indexView" class="table">
    <div class="head_table">
        ...
        <div class="head_search">
            ...
            <div class="head_search_input"><input onkeypress="return enterSearch(event)" id="title" class="input_last" type="text" style="width: 100px !important;" value="" /></div>
            
            <div class="head_search_title">Content:</div>
            <div class="head_search_input"><input onkeypress="return enterSearch(event)" id="search_content" style="width: 100px !important;" onclick="if (this.value == 'type here...') {
                                    this.value = ''
    ...
    <div id="ajax_loadContent"><img class="loading" alt="Ajax Loader" src="<?= PATH_URL_IMAGES . 'static/images/admin/ajax-loader.gif' ?>" /></div>
</div>
<script>
