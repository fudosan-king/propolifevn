                                                                ...
                                                                <table cellspacing="0" cellpadding="0" border="0" width="100%">
                                                                    <tr>
                                                                        ...
                                                                        <td class="right_text_field" style="<?php if($key_array == 0)echo "width:70% !important";?>">
                                                                            ...
                                                                            if (isset($result->month_rent)) {
                                                                                print vcp_printf($result->month_rent, $key);
                                                                            } else {
                                                                                print '';
                                                                            }
                                                            ...
                                                            <div class="row_text_field">
                                                                <table cellspacing="0" cellpadding="0" border="0" width="100%">
                                                                    <tr>
                                                                        ...
                                                                        <td class="right_text_field" style="<?php if($key_array == 0)echo "width:70% !important";?>"><textarea width="100%"  id="introduction_<?php echo $key_array.$key; ?>" name="<?php echo $result->id ?>_introduction[<?= $key; ?>]" cols="" rows="4"><?php
                                                            ...
                                                            <div class="row_text_field">
                                                                <table cellspacing="0" cellpadding="0" border="0" width="100%">
                                                                    <tr>
                                                                        ...
                                                                        <td class="right_text_field" style="<?php if($key_array == 0)echo "width:70% !important";?>"><textarea width="100%" id="comment_<?php echo $key_array.$key; ?>" name="<?php echo $result->id ?>_comment[<?= $key; ?>]" cols="" rows="4"><?php
                                                            ...
                                                            <div class="row_text_field">
                                                                <table cellspacing="0" cellpadding="0" border="0" width="100%">
                                                                    <tr>
                                                                        ...
                                                                        <td class="right_text_field" style="<?php if($key_array == 0)echo "width:70% !important";?>"><textarea width="100%" id="other_notice_<?php echo $key_array.$key; ?>" name="<?php echo $result->id ?>_other_notice[<?= $key; ?>]" cols="" rows="4"><?php
