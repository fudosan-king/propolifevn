...
<div class="main-image">
    ...
    -->
    <div class="slide">
        <?php echo modules::run('offices/slide', $images_gl,$thumb = ''); ?>
    </div>
...
<a href="<?=create_url(); ?>contact/contact_mobile?type=offices&amp;id=<?=$item->id?>"><div class="contact-custom email-contact"><p><?php echo lang('メールで問い合わせる'); ?></p></div></a>
