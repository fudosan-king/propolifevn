<?php $option = array(2=>'User', 1=>'Supper admin') ?>
...
<div class="content_table">
	<table cellspacing="0" cellpadding="0" border="0" width="100%">
		<tr>
			...
			<th class="th_left" onclick="sort('email')"><div id="email" class="sort icon_no_sort">User name</div></th>
			<th class="th_left" onclick="sort('fullname')"><div id="fullname" class="sort icon_no_sort">Full name</div></th>
			...
			<th class="th_last" width="100" onclick="sort('date_created')"><div id="created" class="sort icon_sort_asc">Created</div></th>
		</tr>
		<?php
			if($result){
				$i=0;
		...
		<tr class="item_row<?=$i?> <?php ($k%2==0) ? print 'row1' : print 'row2' ?>">
			...
			<td class="th_left"><a href="<?=PATH_URL.'admincp/'.$module.'/update/'.$v->id?>"><?=($v->fullname)?></a></td>
            <td class="th_left"><?=$option[$v->type];?></td>
