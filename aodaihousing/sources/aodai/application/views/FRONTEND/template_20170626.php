...
<head>
	...
	<script type="text/javascript" defer="defer" src="<?=PATH_URL.'assets/'?>js/jquery.smoothscroll.js"></script>
        ...
        <div class="header">
            ...
            <div class="contact-text">
                ...
                <div class="phone-warp">
                    ...
                    <strong class="phone"><?php echo lang("phone3") ?></strong><br/>
                    <strong class="phone"><?php echo lang("phone4") ?></strong>
                </div>
            </div>
