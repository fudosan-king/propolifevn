...
<head>
    ...
    <link href="<?=PATH_URL?>static/plugin/fancybox/source/jquery.fancybox.css?v=2.1.5" rel="stylesheet"/>
    <script type="text/javascript" defer="defer" src="<?=PATH_URL?>static/plugin/select2/select2.js"></script>
	<script type="text/javascript" src="<?=PATH_URL?>static/plugin/fancybox/source/jquery.fancybox.pack.js?v=2.1.5"></script>
	<script type="text/javascript" src="<?=PATH_URL?>static/plugin/jcarousellite/jcarousellite_1.0.1.js?v=2.1.5"></script>
    <link rel="stylesheet" href="<?=PATH_URL?>static/plugin/jcarousellite/slide.css" type="text/css" media="screen" />
    <script type="text/javascript" defer="defer" src="<?=PATH_URL.'static/js/'?>main.js?v=2.1.5"></script>
