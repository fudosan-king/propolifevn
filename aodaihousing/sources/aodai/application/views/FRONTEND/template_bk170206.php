...
<head>
	...
	<script type="text/javascript" src="<?=PATH_URL.'assets/'?>js/jquery.smoothscroll.js"></script>
	<script type="text/javascript" src="<?=PATH_URL.'assets/'?>js/skrollr.min.js"></script>
        ...
        <div class="header">
            ...
            <div class="contact-text">
                ...
                <div class="phone-warp">
                    ...
                    <strong class="phone"><?php echo lang("phone2") ?></strong><br/>
                    
                    <strong class="phone"><?php echo lang("phone3") ?></strong>
                </div>
            </div>
                ...
                <div class="box-main">
					...
					<div class="right-new-item text-intro">
						<ul>
                            ...
                            <li>
                                <a href="<?=PATH_URL; ?>page/ローカルサービスアパートメント・アパートメントのご紹介">
                                <span>アオザイハウジングではホーチミン市のコンドミニアムほぼ全てをご紹介しております。サイゴンパール、マナー、シティガーデン、ホライズン、カンタビルプレミア、サマセットビスタ、エステラ、インペリア、タオディエンパール、トロピックガーデン、パノラマ、ガーデンコート、リバーパーク、サンライズシティ、スカイガーデンなど気になるコンドミニアムが御座いましたらお気軽にご相談下さい。</span> <br />  
                                </a>
                            </li>
						</ul>
					</div>
