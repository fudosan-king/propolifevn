...
<head>
    ...
    <link rel="stylesheet" href="<?=PATH_URL.'static/css/'?>style_mobile.css" type="text/css">
    <link rel="stylesheet" href="<?=PATH_URL.'static/css/'?>style_mobile_v2.css" type="text/css">
    <?php if(current_lang_() == 'vn'){
    ?>
    <link rel="stylesheet" href="<?=PATH_URL.'static/css/'?>style_mobile_vn.css" type="text/css">
    <?php } ?>
    ...
    <script type="text/javascript" src="<?=PATH_URL.'static/js/'?>main_mobile.js"></script>
