...
define('TIME_TO_BACKUP_AGAIN', 3600 ); // 3days: 259200
...
define('DB_HOST', '133.242.170.72');
define('DB_USERNAME', 'phung');
define('DB_PASSWORD', 'sdj#8ghk*');
define('DB_NAME', 'main_local');
