...
class MY_Lang extends CI_Lang {
    ...
    ***************************************************/
    ...
    function MY_Lang()
    {
        ...
        $url_ok = false;
        if ($this->lang_code && (array_key_exists($this->lang_code, $this->languages)))
        {
    ...
    {
        if ($lang_code && (in_array($lang_code, $this->special)))
            return TRUE;
        else
            return FALSE;
    }
    ...
    function switch_uri($lang)
     {
         if ($this->uri && (array_key_exists($lang, $this->languages)))
         {
