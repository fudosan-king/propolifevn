...
class CI_Mobiles
{
    ...
    public function setUserAgent($userAgent = null)
    {
        if ($userAgent) {
            ...
            foreach($this->getUaHttpHeaders() as $altHeader){
                if(isset($this->httpHeaders[$altHeader])){ // @todo: should use getHttpHeader(), but it would be slow. (Serban)
    ...
    */
    ...
    public function match($regex, $userAgent = null)
    {
        ...
        return (bool) preg_match('/'.$regex.'/is', ($userAgent ? $userAgent : $this->userAgent));
    }
