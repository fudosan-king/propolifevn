...
<div class="table">
    ...
    <div class="row_text_field">
        <table cellspacing="0" cellpadding="0" border="0" width="100%">
            <tr>
                <td class="left_text_field">Information JP:</td>
                <td class="right_text_field"><textarea name="information[jp]" cols="" rows="8"><?php if(isset($result->information)) { echo nl2br(vcp_printf($result->information, 'jp')) ; }else{ print '';} ?></textarea></td>
            </tr>
        </table>
    </div>
    <div class="row_text_field">
        <table cellspacing="0" cellpadding="0" border="0" width="100%">
            <tr>
                <td class="left_text_field">Information VN:</td>
                <td class="right_text_field"><textarea name="information[vn]" cols="" rows="8"><?php if(isset($result->information)) { echo nl2br(vcp_printf($result->information, 'vn')) ; }else{ print '';} ?></textarea></td>
            </tr>
        </table>
    </div>
    <?php
    $option = array(0=>'Both', 1=>'House', 3=>'Office');
    ?>
    <div class="row_text_field">
		<table cellspacing="0" cellpadding="0" border="0" width="100%">
			<tr>
