...
<div class="content_table">
	<table cellspacing="0" cellpadding="0" border="0" width="100%">
		<tr>
            ...
            <th class="th_left" onclick="sort('images')"><div id="title" class="sort icon_no_sort">Image</div></th>
            <th width="70" onclick="sort('order')"><div id="status" class="sort icon_no_sort">Order</div></th>
		...
		<tr class="item_row<?=$i?> <?php ($k%2==0) ? print 'row1' : print 'row2' ?>">
			...
			<td class="th_left td_action">
                <a href="<?=PATH_URL.'admincp/'.$module.'/update/'.$v->id?>"><?=$v->title?></a>
            </td>
            <td class="th_left td_action"><img src="<?=PATH_URL?>static/uploads/bannersidebar/<?=$v->images;?>" /></td>
			<td class="th_left td_action" style="text-align: center;"><?=$v->order;?></td>
