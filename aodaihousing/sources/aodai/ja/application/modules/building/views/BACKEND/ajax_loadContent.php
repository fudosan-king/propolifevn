...
<div class="content_table">
	<table cellspacing="0" cellpadding="0" border="0" width="100%">
		<tr>
            ...
            <th class="th_left" onclick="sort('building_type')"><div id="title" class="sort icon_no_sort">Building_Type</div></th>
            ...
            <th class="th_last" width="100" onclick="sort('modified')"><div id="created" class="sort icon_sort_asc">Updated</div></th>
		</tr>
		<?php
			if($result){
				$i=0;
		...
		<tr class="item_row<?=$i?> <?php ($k%2==0) ? print 'row1' : print 'row2' ?>">
			...
			<td class="th_left td_action"><div class="td_relative">
                    <div class="action"><a href="<?=PATH_URL.'admincp/'.$module.'/update/'.$v->id?>"><img class="action_first" alt="Edit item" src="<?=PATH_URL.'static/images/admin/icons/edit.png'?>" /></a><img onclick="deleteItem(<?=$v->id?>)" alt="Delete item" src="<?=PATH_URL.'static/images/admin/icons/delete.png'?>" /></div><?=vcp_printf($v->name, 'jp'); ?></div>
            </td>
            <td class="th_left td_action"><?php if($v->building_type == '0'){ echo 'Condo';} if($v->building_type == '1'){ echo 'Service aprtment';}?></td>
            ...
            <td class="td_action center"><?php if(isset($v->order)){ echo $v->order;}?></td>
