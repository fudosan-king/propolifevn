					...
					<div class="product-item1 active">
						<?php if($list): ?>
							<?php foreach($list as $item): ?>
								<?php $link = create_url("building/detail-condo/" . $item->id . '/' . vcp_printf($item->name, $language, $replace)); ?>
								<div class="product-detail-area">
									...
									<div class="product-detail-map">
										<a href="<?php echo $link; ?>">
											<?php echo vcp_printf($item->name, $language); ?>
										</a>
                                        <p>
                                        ...
                                        <p>
                                            <?php if(isset($item->address)): ?>
                                                <?php echo vcp_printf($item->address, $language); ?>
                                            <?php endif; ?>
                                        </p>
									</div>
									<div class="clear"></div>
