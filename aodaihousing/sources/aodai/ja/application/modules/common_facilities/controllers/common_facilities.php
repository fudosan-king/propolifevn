...
class Common_facilities extends MX_Controller {

	private $module = 'common_facilities';
	private $table = 'common_facilities';
	function __construct(){
		parent::__construct();
		$this->load->model('common_facilities_model','model');
