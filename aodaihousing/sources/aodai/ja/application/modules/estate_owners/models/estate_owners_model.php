...
class Estate_owners_model extends MY_Model
{
...
//                exit();
    ...
    function saveManagement($fileName = '', $fileName_gallery = '') {
        ...
        if ($this->input->post('hiddenIdAdmincp') == 0) {
            ...
            if ($this->db->insert(PREFIX . $this->table, $data)) {
                ...
                if($this->db->insert('cli_user_info',$data_user_info)){
                ...
                /********save building*********/
                $buildings = $this->input->post('building_type');
                if ($buildings) {
                    $data_select = array(
                        'house_id' => $id_house,
            ...
            if ($this->db->update(PREFIX . $this->table, $data)) {
                ...
                $this->db->update('cli_user_house',$data_user_house);
                /******** Update Building *********/
                $buildings = $this->input->post('building_type');
                if ($buildings) {
                    $this->db->where('house_id', $id_house);
    ...
    function getEquipmentsFolowHouse(){
        $this->db->distinct();
