                ...
                <tr class="item_row<?= $i ?> <?php ($k % 2 == 0) ? print 'row1' : print 'row2' ?>">
                    ...
                    <td class="td_center" <?php if(($v->images_thumb == '') && ($images == '')){ echo 'style="cursor:default"';}?>>
                        <a href="<?= PATH_URL . 'admincp/' . $module . '/update/' . $v->id ?>">
                            ...
                            <img width="150" src="<?= PATH_URL ?>static/uploads/houses/<?php if($v->images_thumb != ''){echo $v->images_thumb;}else{if($images != ''){echo 'gallery/'.$images;}} ?>" />
                            <?php } ?>
                        </a>
                    </td>
                    ...
                    ?>
                    <td class="th_last td_center"><?= date('Y-m-d', strtotime($v->update)) ?></td>
                </tr>
                <?php $i++;
            }
        } else { ?>
