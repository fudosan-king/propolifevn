<div class="feture-1 feture">
    ...
    <?php if($items): ?>
        ...
        <div class="deatil-top <?=$lastChild?>">
            ...
            ?>
                <a href="<?=create_url() . "houses/detail/" . $item->id . '/' . $item->name_en; ?>">
            ...
            <div class="desc">
                <h4 class="title"><span class="icon-new">
                    <a class="title" href="<?=create_url() . "houses/detail/" . $item->id . '/' . $item->name_en;?>">
                        <?=$item->name_jp;?></span>
                    </a>
                </h4>                                              
            ...
            <p class="read-more"><a href="<?=create_url() . "houses/detail/" . $item->id . '/' . $item->name_en;?>">
                <img src="<?=PATH_URL?>static/images/read-more.jpg" /></a>
            </p>
        </div>
        <?php endforeach; ?>
    <?php endif; ?>
