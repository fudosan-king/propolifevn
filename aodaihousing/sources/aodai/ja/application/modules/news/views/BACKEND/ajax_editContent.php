...
<div class="table">
                			...
                			<tr>
                				...
                				<td class="right_text_field" style="padding-right: 0px;">
                					...
                					<script type="text/javascript">
                						...
                						oEdit1_<?=$key?>.cmdAssetManager="modalDialogShow('"+root+"static/editor/assetmanager/assetmanager.php',675,445);";
	...
	<div class="row_text_field" style="">
		<table cellspacing="0" cellpadding="0" border="0" width="100%">
			<tr>
