        ...
        <div class="pics" id="image-list">
                ...
                <?php if($images_gl): ?>
                    <?php foreach($images_gl as $gls): ?>
                        <li id="recordsArray_<?=$gls->id?>"><a title="" href="#"><img width="101" height="101" alt="" src="<?=PATH_URL?>static/uploads/offices/gallery/<?=$gls->name_image;?>"></a>
                            <div style="display: none;" class="actions">
                            
                                <a title="" href="javascript:void(0)"><img onclick="deleteItemGl('<?=$gls->id; ?>', this)" alt="" src="<?=PATH_URL?>static/images/admin/icons/delete.png"></a>
                            </div>
                        </li>
                    <?php endforeach; ?>
                <?php endif; ?>
