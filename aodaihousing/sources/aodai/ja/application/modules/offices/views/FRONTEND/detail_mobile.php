...
<div class="main-image">
    <!-- <a href="#"><div class="prev-img"><img src="<?=PATH_URL.'static/images/aodai_mobile/'?>prev_img.png"></div></a>
        <a href="#"><div class="next-img"><img src="<?=PATH_URL.'static/images/aodai_mobile/'?>next_img.png"></div></a>
    -->
    <div class="slide">
...
<a href="<?=create_url(); ?>contact/contact_mobile?type=office&amp;id=<?=$item->id?>"><div class="contact-custom email-contact"><p><?php echo lang('メールで問い合わせる'); ?></p></div></a>
...
<div class="form-info">
        ...
        <div class="right-info">
            <p>
                <?php
                    $get_month_rent = '';
                    if ($item->month_rent) {
                        $get_month_rent = $item->month_rent . ' USD/月';
                    }
                    echo $get_month_rent;
                    ...
                    echo $get_month_size_rent;

                    $get_size_rent = '';
                    if ($item->size_rent) {
                        $get_size_rent = $item->size_rent . ' USD/m&#178;';
                    }
                ?>
            </p>
        </div>
    ...
    <div class="field-rows">
        ...
        <div class="right-info"><p>TESTTTT</p></div>
    </div>
...
<div class="form-info">
    ...
    <div class="condition-table-rows">
        ...
        <div class="col2"><p><?php echo vcp_printf($item->phone_bill, current_lang_()); ?></p></div>
    </div>
    ...
    <div class="condition-table-rows consumables">
        <div class="col1 consumables"><p><?php echo lang('プレミアムNHK'); ?>）</p></div>
        <div class="col2 consumables"><p><?php echo vcp_printf($item->premium_nhk, current_lang_()); ?></p></div>
        <div class="col1 consumables"><p><?php echo lang('門限時間'); ?></p></div>
        <div class="col2 consumables"><p><?php echo vcp_printf($item->closing_time, current_lang_()); ?></p></div>
    </div>

    <div class="condition-table-rows">
        <div class="col1"><p><?php echo lang('鍵'); ?></p></div>
        <div class="col2"><p><?php echo vcp_printf($item->key, current_lang_());?></p></div>
        <div class="col1"><p><?php echo lang('セキュリティ'); ?></p></div>
        <div class="col2"><p><?php echo vcp_printf($item->security, current_lang_());?></p></div>
    </div>
