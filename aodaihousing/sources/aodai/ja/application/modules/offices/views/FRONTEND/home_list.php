<div class="feture-2 feture">
    ...
    <?php if($items): ?>
        ...
        <div class="item">
            <a href="<?=create_url() . "offices/detail/" . $item->id . '/' . $item->name_en;?>"><img src="<?=PATH_URL?>static/uploads/offices/<?=$item->images_thumb;?>" /></a>
            <a href="<?=create_url() . "offices/detail/" . $item->id . '/' . $item->name_en;?>"><h4>ＪＲ京浜東北線ファミリー物件</h4></a>
            <p class="content">
