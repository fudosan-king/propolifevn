				<div class="left_content" style="background: #fff;">
					<div class="gr_list_news" style="width: 610px;">
						...
						<div class="gr_item_list_news">
							<div class="item_image" onclick="location.href='<?=create_url().SEOHTML($name_sub[0]->name).'/'.SEOHTML($name_cat[0]->name).'/'.$v->id.'/'.SEO($v->title)?>'" style="background: url(<?=create_url().'static/uploads/news/medium/'.$v->image?>) center center no-repeat; width: 150px; height: 90px; cursor: pointer;"></div>
