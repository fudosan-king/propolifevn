	...
	<div class="container">
		...
		<div class="office-sample">
			...
			<div class="common-content-block content-support">
				<p class="bold-text">
					<?php echo lang('allGrowLabo_paragraph_1'); ?>
				</p>
			</div>
			
			<div class="common-content-block content-support">
				<p class="common-text">
					<?php echo lang('allGrowLabo_paragraph_2'); ?>
				</p>
				<div class="image-sample">
					<img src="<?php echo PATH_URL; ?>static/images/office_sample/office-sample59.jpg" alt="" />
				</div>
			</div>
			
			<div class="common-content-block content-support">
				<p class="common-text">
					<?php echo lang('allGrowLabo_paragraph_3'); ?>
				</p>
				<div class="image-sample">
					<img src="<?php echo PATH_URL; ?>static/images/office_sample/office-sample60.jpg" alt="" />
				</div>
			</div>

			<div class="common-content-block content-support">
				<p class="common-text">
					<?php echo lang('allGrowLabo_paragraph_4'); ?>
				</p>
				<div class="image-sample">
					<img src="<?php echo PATH_URL; ?>static/images/office_sample/office-sample61.jpg" alt="" />
				</div>
			</div>

			<div class="common-content-block content-support">
				<p class="common-text">
					<?php echo lang('allGrowLabo_paragraph_5'); ?>
				</p>
				<div class="image-sample">
					<img src="<?php echo PATH_URL; ?>static/images/office_sample/office-sample62.jpg" alt="" />
				</div>
			</div>

			<div class="common-content-block content-support">
				<p class="common-text">
					<?php echo lang('allGrowLabo_paragraph_6'); ?>
				</p>
				<div class="image-sample">
					<img src="<?php echo PATH_URL; ?>static/images/office_sample/office-sample63.jpg" alt="" />
				</div>
			</div>

			<div class="common-content-block content-support">
				<p class="common-text">
					<?php echo lang('allGrowLabo_paragraph_7'); ?>
				</p>
			</div>

			<div class="common-content-block content-support">
				<p class="bold-text">
					<?php echo lang('allGrowLabo_paragraph_8'); ?>
				</p>
				<p class="common-text">
					<a href='http://allgrow-labo.jp/blog/20170628/'>http://allgrow-labo.jp/blog/20170628/</a>
				</p>
			</div>
