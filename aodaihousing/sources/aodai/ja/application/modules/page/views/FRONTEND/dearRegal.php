	...
	<div class="container">
		...
		<div class="office-sample">
			...
			<div class="common-content-block content-support">
				<p class="bold-text">
					<?php echo lang('dearRegal_paragraph_1'); ?>
				</p>
			</div>
			
			<div class="common-content-block content-support">
				<p class="common-text">
					<?php echo lang('dearRegal_paragraph_2'); ?>
				</p>
				<div class="image-sample">
					<img src="<?php echo PATH_URL; ?>static/images/office_sample/office-sample64.jpg" alt="" />
				</div>
			</div>
			
			<div class="common-content-block content-support">
				<p class="common-text">
					<?php echo lang('dearRegal_paragraph_3'); ?>
				</p>
				<div class="image-sample">
					<img src="<?php echo PATH_URL; ?>static/images/office_sample/office-sample65.jpg" alt="" />
				</div>
			</div>

			<div class="common-content-block content-support">
				<p class="common-text">
					<?php echo lang('dearRegal_paragraph_4'); ?>
				</p>
				<div class="image-sample">
					<img src="<?php echo PATH_URL; ?>static/images/office_sample/office-sample66.jpg" alt="" />
				</div>
			</div>

			<div class="common-content-block content-support">
				<p class="common-text">
					<?php echo lang('dearRegal_paragraph_5'); ?>
				</p>
				<div class="image-sample">
					<img src="<?php echo PATH_URL; ?>static/images/office_sample/office-sample67.jpg" alt="" />
				</div>
			</div>

			<div class="common-content-block content-support">
				<p class="common-text">
					<?php echo lang('dearRegal_paragraph_6'); ?>
				</p>
				<div class="image-sample">
					<img src="<?php echo PATH_URL; ?>static/images/office_sample/office-sample68.jpg" alt="" />
				</div>
			</div>

			<div class="common-content-block content-support">
				<p class="common-text">
					<?php echo lang('dearRegal_paragraph_7'); ?>
				</p>
				<div class="image-sample">
					<img src="<?php echo PATH_URL; ?>static/images/office_sample/office-sample69.jpg" alt="" />
				</div>
			</div>

			<div class="common-content-block content-support">
				<p class="common-text">
					<?php echo lang('dearRegal_paragraph_8'); ?>
				</p>
				<div class="image-sample">
					<img src="<?php echo PATH_URL; ?>static/images/office_sample/office-sample70.jpg" alt="" />
					<img src="<?php echo PATH_URL; ?>static/images/office_sample/office-sample71.jpg" alt="" />
				</div>
			</div>

			<div class="common-content-block content-support">
				<p class="common-text">
					<?php echo lang('dearRegal_paragraph_9'); ?>
				</p>
			</div>
