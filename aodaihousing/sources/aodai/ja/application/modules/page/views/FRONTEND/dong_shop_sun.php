	...
	<div class="container">
		...
		<div class="office-sample">
			<h4 class="red-heading-title">
				<?php echo lang('dong_shop_sun_h4'); ?>
			</h4>
			...
			<div class="common-content-block content-support">
				<p class="bold-text">
					<?php echo lang('dong_shop_sun_paragraph_1'); ?>
				</p>
			</div>
			
			<div class="common-content-block content-support">
				<p class="common-text">
					<?php echo lang('dong_shop_sun_paragraph_2'); ?>
				</p>
				<div class="image-sample">
					<img src="<?php echo PATH_URL; ?>static/images/office_sample/office-sample44.png" alt="" />
					<img src="<?php echo PATH_URL; ?>static/images/office_sample/office-sample45.png" alt="" />
				</div>
			</div>
			
			<div class="common-content-block content-support">
				<p class="common-text">
					<?php echo lang('dong_shop_sun_paragraph_3'); ?>
				</p>
				<div class="image-sample">
					<img src="<?php echo PATH_URL; ?>static/images/office_sample/office-sample46.png" alt="" />
					<img src="<?php echo PATH_URL; ?>static/images/office_sample/office-sample47.png" alt="" />
				</div>
			</div>

			<div class="common-content-block content-support">
				<p class="common-text">
					<?php echo lang('dong_shop_sun_paragraph_4'); ?>
				</p>
				<div class="image-sample">
					<img src="<?php echo PATH_URL; ?>static/images/office_sample/office-sample48.png" alt="" />
					<img src="<?php echo PATH_URL; ?>static/images/office_sample/office-sample49.png" alt="" />
				</div>
			</div>

			<div class="common-content-block content-support">
				<p class="common-text">
					<?php echo lang('dong_shop_sun_paragraph_5'); ?>
				</p>
				<div class="image-sample">
					<img src="<?php echo PATH_URL; ?>static/images/office_sample/office-sample50.png" alt="" />
				</div>
			</div>

			<div class="common-content-block content-support">
				<p class="common-text">
					<?php echo lang('dong_shop_sun_paragraph_6'); ?>
				</p>
			</div>
