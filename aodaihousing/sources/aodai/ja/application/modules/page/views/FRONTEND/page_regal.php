    ...
    <div class="container">
        ...
        <div class="office-sample">
            ...
            <div class="common-content-block content-support">
                <p class="bold-text">
                    <?php echo lang('page_regal_paragraph_1');?>
                </p>
            </div>
            <div class="common-content-block content-support">
                <p class="common-text">
                    <?php echo lang('page_regal_paragraph_2');?>
                </p>
                <div class="image-sample">
                    <img src="<?php echo PATH_URL.'static/images/office_sample/office-sample1.jpg';?>" alt="" />
                </div>
            </div>
            <div class="common-content-block content-support">
                <p class="common-text">
                    <?php echo lang('page_regal_paragraph_3');?>
                </p>
                <div class="image-sample">
                    <img src="<?php echo PATH_URL.'static/images/office_sample/office-sample2.jpg';?>" alt="" />
                    <img src="<?php echo PATH_URL.'static/images/office_sample/office-sample3.jpg';?>" alt="" />
                </div>
            </div>
            <div class="common-content-block content-support">
                <p class="common-text">
                    <?php echo lang('page_regal_paragraph_4');?>
                </p>
                <div class="image-sample">
                    <img src="<?php echo PATH_URL.'static/images/office_sample/office-sample4.jpg';?>" alt="" />
                    <img src="<?php echo PATH_URL.'static/images/office_sample/office-sample5.jpg';?>" alt="" />
                </div>
            </div>
            <div class="common-content-block content-support">
                <p class="common-text">
                    <?php echo lang('page_regal_paragraph_5');?>
                </p>
                <p class="common-text">
                    <?php echo lang('page_regal_paragraph_6')?>
                </p>
                <div class="image-sample">
                    <img src="<?php echo PATH_URL.'static/images/office_sample/office-sample6.jpg';?>" alt="" />
                </div>
            </div>
            <div class="common-content-block content-support">
                <p class="common-text">
                    <?php echo lang('page_regal_paragraph_7')?>
                </p>
                <div class="image-sample">
                    <img src="<?php echo PATH_URL.'static/images/office_sample/office-sample7.jpg';?>" alt="" />
                </div>
            </div>
            <div class="common-content-block content-support">
                <p class="common-text">
                    <?php echo lang('page_regal_paragraph_8')?>
                </p>
                <div class="image-sample">
                    <img src="<?php echo PATH_URL.'static/images/office_sample/office-sample8.jpg'?>" alt="" />
                </div>
            </div>
            <div class="common-content-block content-support">
                <p class="common-text">
                    <?php echo lang('page_regal_paragraph_9')?>
                </p>
                <div class="image-sample">
                    <img src="<?php echo PATH_URL.'static/images/office_sample/office-sample9.jpg';?>" alt="" />
                </div>
            </div>
            <div class="common-content-block content-support">
                <p class="common-text">
                    <?php echo lang('page_regal_paragraph_10')?>
                </p>
                <p class="common-text">
                    <?php echo lang('page_regal_paragraph_11')?>
                </p>
            </div>
