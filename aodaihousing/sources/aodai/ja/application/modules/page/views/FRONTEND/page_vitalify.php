    ...
    <div class="container">
        ...
        <div class="office-sample">
            <h4 class="red-heading-title">
                <?php echo lang('page_vitalify_h4')?>
            </h4>
            ...
            <div class="common-content-block content-support">
                <p class="bold-text">
                    <?php echo lang('page_vitalify_paragraph_1')?>
                </p>
            </div>
            <div class="common-content-block content-support">
                <p class="common-text">
                    <?php echo lang('page_vitalify_paragraph_2')?>
                </p>
                <div class="image-sample">
                    <img src="<?php echo PATH_URL.'static/images/office_sample/office-sample10.jpg';?>" alt="" />
                    <img src="<?php echo PATH_URL.'static/images/office_sample/office-sample11.jpg';?>" alt="" />
                </div>
            </div>
            <div class="common-content-block content-support">
                <p class="common-text">
                    <?php echo lang('page_vitalify_paragraph_3')?>
                </p>
                <div class="image-sample">
                    <img src="<?php echo PATH_URL.'static/images/office_sample/office-sample12.jpg';?>" alt="" />
                </div>
            </div>
            <div class="common-content-block content-support">
                <p class="common-text">
                    <?php echo lang('page_vitalify_paragraph_4')?>
                </p>
                <div class="image-sample">
                    <img src="<?php echo PATH_URL.'static/images/office_sample/office-sample13.jpg';?>" alt="" />
                    <img src="<?php echo PATH_URL.'static/images/office_sample/office-sample14.jpg';?>" alt="" />
                </div>
            </div>
            <div class="common-content-block content-support">
                <p class="common-text">
                    <?php echo lang('page_vitalify_paragraph_5')?>
                </p>
                <div class="image-sample">
                    <img src="<?php echo PATH_URL.'static/images/office_sample/office-sample15.jpg';?>" alt="" />
                    <img src="<?php echo PATH_URL.'static/images/office_sample/office-sample16.jpg';?>" alt="" />
                    <img src="<?php echo PATH_URL.'static/images/office_sample/office-sample17.jpg';?>" alt="" />
                    <img src="<?php echo PATH_URL.'static/images/office_sample/office-sample18.jpg';?>" alt="" />
                </div>
            </div>

            <div class="common-content-block content-support">
                <p class="common-text">
                    <?php echo lang('page_vitalify_paragraph_6')?>
                </p>
                <p class="common-text">
                    <?php echo lang('page_vitalify_paragraph_7')?>
                </p>
            </div>
