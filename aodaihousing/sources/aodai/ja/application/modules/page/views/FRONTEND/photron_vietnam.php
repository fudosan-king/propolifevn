	...
	<div class="container">
		...
		<div class="office-sample">
			<h4 class="red-heading-title">
				<?php echo lang('photron_vietnam_h4'); ?>
			</h4>
			...
			<div class="common-content-block content-support">
				<p class="bold-text">
					<?php echo lang('photron_vietnam_paragraph_1'); ?>
				</p>
			</div>
			
			<div class="common-content-block content-support">
				<p class="common-text">
					<?php echo lang('photron_vietnam_paragraph_2'); ?>
				</p>
				<div class="image-sample">
					<img src="<?php echo PATH_URL; ?>static/images/office_sample/office-sample37.jpg" alt="" />
				</div>
			</div>
			
			<div class="common-content-block content-support">
				<p class="common-text">
					<?php echo lang('photron_vietnam_paragraph_3'); ?>
				</p>
				<div class="image-sample">
					<img src="<?php echo PATH_URL; ?>static/images/office_sample/office-sample38.jpg" alt="" />
					<img src="<?php echo PATH_URL; ?>static/images/office_sample/office-sample39.jpg" alt="" />
				</div>
			</div>

			<div class="common-content-block content-support">
				<p class="common-text">
					<?php echo lang('photron_vietnam_paragraph_4'); ?>
				</p>
				<div class="image-sample">
					<img src="<?php echo PATH_URL; ?>static/images/office_sample/office-sample40.jpg" alt="" />
				</div>
			</div>

			<div class="common-content-block content-support">
				<p class="common-text">
					<?php echo lang('photron_vietnam_paragraph_5'); ?>
				</p>
				<div class="image-sample">
					<img src="<?php echo PATH_URL; ?>static/images/office_sample/office-sample41.jpg" alt="" />
				</div>
			</div>

			<div class="common-content-block content-support">
				<p class="common-text">
					<?php echo lang('photron_vietnam_paragraph_6'); ?>
				</p>
				<div class="image-sample">
					<img src="<?php echo PATH_URL; ?>static/images/office_sample/office-sample42.jpg" alt="" />
				</div>
			</div>

			<div class="common-content-block content-support">
				<p class="common-text">
					<?php echo lang('photron_vietnam_paragraph_7'); ?>
				</p>
				<div class="image-sample">
					<img src="<?php echo PATH_URL; ?>static/images/office_sample/office-sample43.jpg" alt="" />
				</div>
			</div>

			<div class="common-content-block content-support">
				<p class="common-text">
					<?php echo lang('photron_vietnam_paragraph_8'); ?>
				</p>
			</div>
