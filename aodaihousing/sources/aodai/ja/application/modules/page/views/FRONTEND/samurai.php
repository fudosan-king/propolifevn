	...
	<div class="container">
		...
		<div class="office-sample">
			...
			<div class="common-content-block content-support">
				<p class="bold-text">
					<?php echo lang('samurai_paragraph_1'); ?>
				</p>
			</div>
			
			<div class="common-content-block content-support">
				<p class="common-text">
					<?php echo lang('samurai_paragraph_2'); ?>
				</p>
				<div class="image-sample">
					<img src="<?php echo PATH_URL; ?>static/images/office_sample/office-sample51.jpg" alt="" />
				</div>
			</div>
			
			<div class="common-content-block content-support">
				<p class="common-text">
					<?php echo lang('samurai_paragraph_3'); ?>
				</p>
				<div class="image-sample">
					<img src="<?php echo PATH_URL; ?>static/images/office_sample/office-sample52.jpg" alt="" />
				</div>
			</div>

			<div class="common-content-block content-support">
				<p class="common-text">
					<?php echo lang('samurai_paragraph_4'); ?>
				</p>
				<div class="image-sample">
					<img src="<?php echo PATH_URL; ?>static/images/office_sample/office-sample53.jpg" alt="" />
				</div>
			</div>

			<div class="common-content-block content-support">
				<p class="common-text">
					<?php echo lang('samurai_paragraph_5'); ?>
				</p>
				<div class="image-sample">
					<img src="<?php echo PATH_URL; ?>static/images/office_sample/office-sample54.jpg" alt="" />
				</div>
			</div>

			<div class="common-content-block content-support">
				<p class="common-text">
					<?php echo lang('samurai_paragraph_6'); ?>
				</p>
				<div class="image-sample">
					<img src="<?php echo PATH_URL; ?>static/images/office_sample/office-sample55.jpg" alt="" />
					<img src="<?php echo PATH_URL; ?>static/images/office_sample/office-sample56.jpg" alt="" />
				</div>
			</div>

			<div class="common-content-block content-support">
				<p class="common-text">
					<?php echo lang('samurai_paragraph_7'); ?>
				</p>
				<div class="image-sample">
					<img src="<?php echo PATH_URL; ?>static/images/office_sample/office-sample57.jpg" alt="" />
					<img src="<?php echo PATH_URL; ?>static/images/office_sample/office-sample58.jpg" alt="" />
				</div>
			</div>

			<div class="common-content-block content-support">
				<p class="common-text">
					<?php echo lang('samurai_paragraph_8'); ?>
				</p>
			</div>
