...
<div class="content_table">
    <table cellspacing="0" cellpadding="0" border="0" width="100%">
        <tr>
            ...
            <th class="th_left" onclick="sort('username')"><div id="title" class="sort icon_no_sort">FullName</div></th>
            ...
            foreach ($result as $k => $v) {
                ...
                <tr class="item_row<?= $i ?> <?php ($k % 2 == 0) ? print 'row1' : print 'row2' ?>">
                    ...
                    <td class="th_left td_action">
                        <a href="<?= PATH_URL . 'admincp/' . $module . '/update/' . $v->id ?>"><?= nl2br(vcp_printf($v->username,'jp')) ?></a>
                    </td>
