                        ...
                        <div class="table">
                            ...
                            <div class="widget" style="margin-top: 20px;">
                                <ul class="tabs">
                                    ...
                                    <?php endforeach; ?>
                                    <div style="margin: 10px 0 0 130px;font-weight: bold"><span><?php print vcp_printf($result->username, $key); ?></span></div>
                                </ul>
                                                ...
                                                <table cellspacing="0" cellpadding="0" border="0" width="100%">
                                                    <tr>
                                                        ...
                                                        <td class="right_text_field" style="<?php if($key_array == 0)echo "width:70% !important";?>">
                                                            <input  class="groupRequired" style="width:100% !important" value="<?php
                                                            if (isset($result->username)) {
                                                                print vcp_printf($result->username, $key);
                                                            } else {
                                                                print '';
                                                            }
                                                            ?>" type="text" name="<?php echo $result->id ?>_username_<?= $key; ?>" id="username_<?php echo $key_array.$key; ?>" />
                                                        </td>
                                                        <?php if ($key_array == 0): ?>
                                                            <td class="apply_td">
                                                                <a  href="javascript:void(0)" onclick="return aplly_all_username(<?php echo $number ?>)">
                                            ...
                                            <div class="row_text_field">
                                                <table cellspacing="0" cellpadding="0" border="0" width="100%">
                                                    <tr>
                                                        ...
                                                        <td class="right_text_field" style="<?php if($key_array == 0)echo "width:70% !important";?>">
                                                            <input  class="email" style="width:100% !important" value="<?php
                                                            if (isset($result->email)) {
                                                                print vcp_printf($result->email);
                                                            } else {
                                                                print '';
                                                            }
                                                            ?>" type="text" name="<?php echo $result->id ?>_email_<?= $key; ?>" id="email_<?php echo $key_array.$key; ?>" />
                                                        </td>
                                                        <?php if ($key_array == 0): ?>
                                                            <td class="apply_td">
                                                                <a  href="javascript:void(0)" onclick="return aplly_all_email(<?php echo $number ?>)">
                                                                    <span class="apply">apply all</span>
                                                                </a>
                                                            </td>
                                                        <?php endif; ?>
                                            ...
                                            <div class="row_text_field">
                                                <table cellspacing="0" cellpadding="0" border="0" width="100%">
                                                    <tr>
                                                        ...
                                                        <td class="right_text_field" style="<?php if($key_array == 0)echo "width:70% !important";?>">
                                                            <input  class="validate[custom[number]]" style="width:100% !important" value="<?php
                                                            if (isset($result->phone)) {
                                                                print vcp_printf($result->phone, $key);
                                                            } else {
                                                                print '';
                                                            }
                                                            ?>" type="text" name="<?php echo $result->id ?>_phones_<?= $key; ?>" id="phone_<?php echo $key_array.$key; ?>" />
                                                        </td>
                                                        <?php if ($key_array == 0): ?>
                                                            <td class="apply_td">
                                                                <a  href="javascript:void(0)" onclick="return aplly_all_phone(<?php echo $number ?>)">
                                                                    <span class="apply">apply all</span>
                                                                </a>
                                                            </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="right_text_field" style="<?php if($key_array == 0)echo "width:70% !important";?>">
                                                            ...
                                                            if (isset($result->address)) {
                                                                print vcp_printf($result->address, $key);
                                                            } else {
                                                                print '';
                                                            }
                                                            ?>" type="text" name="<?php echo $result->id ?>_address_<?= $key; ?>" id="address_<?php echo $key_array.$key; ?>" />
                                                        </td>
                                                        <?php if ($key_array == 0): ?>
                                                            <td class="apply_td">
                                                                <a  href="javascript:void(0)" onclick="return aplly_all_address(<?php echo $number ?>)">
                                                                    <span class="apply">apply all</span>
                                                                </a>
                                                            </td>
                                                        <?php endif; ?>
...
<script>
    function aplly_all_username($number) {
        var username_jp = $("#username_0jp").val();
        var username_vn = $("#username_0vn").val();
        for (var i = 1; $number >= i; i++) {
            $("#username_" + i+'jp').val(username_jp);
            $("#username_" + i+'vn').val(username_vn);
        }
    }
    function aplly_all_email($number) {
        var email_jp = $("#email_0jp").val();
        var email_vn = $("#email_0vn").val();
        for (var i = 1; $number >= i; i++) {
            $("#email_" + i+'jp').val(email_jp);
            $("#email_" + i+'vn').val(email_vn);
        }
    }

    function aplly_all_phone($number) {
        var phone_jp = $("#phone_0jp").val();
        var phone_vn = $("#phone_0vn").val();
        for (var i = 1; $number >= i; i++) {
            $("#phone_" + i+'jp').val(phone_jp);
            $("#phone_" + i+'vn').val(phone_vn);
        }
    }
    function aplly_all_address($number) {
        var address_jp = $("#address_0jp").val();
        var address_vn = $("#address_0jp").val();
        for (var i = 1; $number >= i; i++) {
            $("#address_" + i+'jp').val(address_jp);
            $("#address_" + i+'vn').val(address_vn);
        }
    }
</script>
