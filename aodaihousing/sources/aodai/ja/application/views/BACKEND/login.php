...
<link rel="stylesheet" href="<?=PATH_URL?>static/css/admin/login.css?v=<?php echo VERSION_SCRIPT; ?>" type="text/css">
<script type="text/javascript">
var root = '<?=PATH_URL?>';
</script>
<script type="text/javascript" src="<?=PATH_URL?>static/js/jquery-1.7.1.min.js?v=<?php echo VERSION_SCRIPT; ?>"></script>
<script type="text/javascript" src="<?=PATH_URL?>static/js/admin/login.js?v=<?php echo VERSION_SCRIPT; ?>"></script>
