...
<head>
    ...
    <link rel="stylesheet" href="<?=PATH_URL.'static/css/'?>/style.css?v=<?php echo VERSION_SCRIPT; ?>" />
    <?php if(current_lang_() == 'vn'): ?>
    <link rel="stylesheet" href="<?=PATH_URL.'static/css/'?>/vn.css?v=<?php echo VERSION_SCRIPT; ?>" />
    <?php endif ?>
    <?php
    ...
    elseif(preg_match('/Mac/',$agent)){
        echo "<link rel='stylesheet' href='".PATH_URL."static/css/mac.css?v=". VERSION_SCRIPT . "' type='text/css' media='all' />";
        if(current_lang_() == 'vn'){
            echo "<link rel='stylesheet' href='".PATH_URL."static/css/vn-mac.css?v=". VERSION_SCRIPT . "' type='text/css' media='all' />";    
        }
        ?>
        <style type="text/css">
            .menu-item li a span{
    ...
    <script type="text/javascript" src="<?=PATH_URL?>static/plugin/slideshow/js/jquery.transition.min.js?v=<?php echo VERSION_SCRIPT; ?>"></script>
    ...
    <script type="text/javascript" src="<?=PATH_URL?>static/plugin/select2/select2.js?v=<?php echo VERSION_SCRIPT; ?>"></script>
	...
	<script type="text/javascript" src="<?=PATH_URL?>static/plugin/jcarousellite/jcarousellite_1.0.1.js?v=<?php echo VERSION_SCRIPT; ?>"></script>
    <link rel="stylesheet" href="<?=PATH_URL?>static/plugin/jcarousellite/slide.css?v=<?php echo VERSION_SCRIPT; ?>" type="text/css" media="screen" />
    <script type="text/javascript" src="<?=PATH_URL.'static/js/'?>main.js?v=<?php echo VERSION_SCRIPT; ?>"></script>
