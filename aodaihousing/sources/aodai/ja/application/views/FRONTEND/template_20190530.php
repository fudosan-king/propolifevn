...
<html lang="ja">
    <head>
        ...
        <?php else:?>
            <link  rel="stylesheet" type ="text/css" href="<?php echo PATH_URL . 'static/css/'?>compress_css.css">
        <?php endif;?>
        ...
        <?php elseif(!$is_home && isMobileDevice()):?>
            ...
            <link async rel="stylesheet" type="text/css" href="<?php echo PATH_URL . 'static/css/';?>subpage-responsive.css">
        <?php else:?>
            <link rel="stylesheet" type ="text/css" href="<?php echo PATH_URL . 'static/css/'?>style.css">
        <?php endif;?>
        ...
        <?php if (is_responsive()):?>
            <!-- main-responsive.css -->
            <link rel="stylesheet" href="<?php echo PATH_URL . 'static/css/';?>main-responsive.css">
            ...
            <div class="menu-header <?php echo $is_home === false ? 'common-header' : '';?>">
                ...
                <div class="top-menu">
                    <div class="container">
                        <div class="row">
                            <?php if (is_responsive()):?>
                            <div class="col-xs-2 col-sm-2 col-md-2 col-lg-3 padding">
                            ...
                            <?php else: ?>
                            <div class="col-xs-3 col-md-2 col-lg-3 padding">
                                <div class="block-logo">
                                    <p>ホーチミン不動産賃貸<br/>アオザイハウジング</p>
                                    <a href="<?php if (current_lang_() == 'jp'):?> <?php echo PATH_URL . '';?> <?php else:?> <?php echo PATH_URL . 'vn/';?> <?php endif;?>">
                                    <img src="<?php echo PATH_URL . 'static/images';?>/logo.png" alt="logo"/>
                            ...
                            <?php endif; ?>
                            <div class="col-xs-2 block-hidden padding">
                                <div class="block-contact-phone">
                                    <p class="spritephone">代表（日本語可）</p>
                                    <span></span>
                                    <p>＋84-28-3827-5068</p>
                                </div>
                            </div>
                            <div class="col-xs-3 block-hidden padding">
                                <div class="block-contact-phone block-contact-phone-jp">
                                    <p class="spritephone">日本人担当：魚山（ウオヤマ）</p>
                                    <span></span>
                                    <p>＋84（0）917-835-778</p>
                                </div>
                            </div>
                            <?php if (is_responsive()):?>
                            <div class="col-xs-3 padding">
                                <div class="block-contact-phone block-contact-phone-common block-contact-phone-layout">
                                    <p class="spritephone">担当：魚山</p>
                                    <span></span>
                                    <p><a href="tel:+84917835778">＋84-91-783-5778</a></p>
                                </div>
                            </div>
                            <div class="col-xs-3 padding">
                                <div class="block-contact-phone block-contact-phone-common">
                                    <p class="spritephone">電話番号</p>
                                    <span></span>
                                    <p><a href="tel:+842838275068">＋84-28-3827-5068</a></p>
                                </div>
                            </div>
                            <?php endif; ?>
                            <div class="col-xs-3 padding">
