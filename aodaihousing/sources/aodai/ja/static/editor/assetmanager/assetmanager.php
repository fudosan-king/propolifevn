...
function selectFile(index)
  ...
  if(sFile_Extension.toUpperCase()=="GIF" || sFile_Extension.toUpperCase()=="JPG" || sFile_Extension.toUpperCase()=="PNG")
    {
    sHTML = "<img src=\""+ path_url + sFile_RelativePath + "\" >"
    }
  //SWF
    ...
    sHTML = "<object "+
      ...
      " <param name=movie value='"+ path_url + sFile_RelativePath+"'>" +
      " <param name=quality value='high'>" +
      " <embed src='"+ path_url + sFile_RelativePath+"' " +
      "   width='100%' " +
      "   height='100%' " +
      "   quality='high' " +
  ...
  //Video
    ...
    {
    sHTML = "<embed src='"+ path_url + sFile_RelativePath+"' hidden=false autostart='true' type='video/avi' loop='true'></embed>";
    }
  //Sound
  else if(sFile_Extension.toUpperCase()=="WMA"||sFile_Extension.toUpperCase()=="WAV"||sFile_Extension.toUpperCase()=="MID")
    {
    sHTML = "<embed src='"+ path_url + sFile_RelativePath+"' hidden=false autostart='true' type='audio/wav' loop='true'></embed>";
    }
  //Files (Hyperlinks)
  else
    {
...
<td class="dialogFooter" align="right">
  ...
  <tr>
  <td>
  <input name="btnOk" id="btnOk" type="button" value=" ok " onclick="doOk()" class="inpBtn" style="margin-bottom: 20px" onmouseover="this.className='inpBtnOver';" onmouseout="this.className='inpBtnOut'">
  </td>
  </tr>
  </table>
</td>
