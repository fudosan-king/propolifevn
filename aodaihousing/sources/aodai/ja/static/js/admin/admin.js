...
function deleteAll() {
    if (isCheckedAll() == false) {
        alert('Please choose data want delete.');
    } else {
 ...
 */
function fn_config_toolbar_ckeditor() {
    var object = {
        ...
        removeButtons: 'Save,Paste,PasteText,PasteFromWord',
        // Config with CKFinder
        filebrowserBrowseUrl : root + 'static/plugin/ckfinder/ckfinder.html',
        filebrowserImageBrowseUrl : root + 'static/plugin/ckfinder/ckfinder.html?type=Images',
        filebrowserFlashBrowseUrl : root + 'static/plugin/ckfinder/ckfinder.html?type=Flash',
        filebrowserUploadUrl : root + 'static/plugin/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Files',
        filebrowserImageUploadUrl : root + 'static/plugin/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Images',
        filebrowserFlashUploadUrl : root + 'static/plugin/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Flash'
    }
    return object;
}