				<div class="left_content" style="background: #fff; width: 520px;">
					<div class="gr_list_news" style="width: 500px;">
						...
						<div class="banner_bottom_detail">
							<a onclick="clickBanner(<?=$v->id?>)" target="_blank" href="<?=$v->link?>"><img width="468" height="60" alt="2dep Banner Right Detail" src="<?=PATH_URL_IMAGES.'static/uploads/banner/'.$v->image?>" /></a>
						</div>
						<?php }else{ ?>
						<div class="banner_bottom_detail">
							<a href="<?=$v->link?>" target="_blank" onclick="clickBanner(<?=$v->id?>)">
								<object width="468" height="60" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000">
									<param value="<?=PATH_URL_IMAGES.'static/uploads/banner/'.$v->image?>" name="movie">
									<param value="transparent" name="wmode">
									<param value="high" name="quality">
									<embed width="468" height="60" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" quality="high" wmode="transparent" allowfullscreen="true" src="<?=PATH_URL_IMAGES.'static/uploads/banner/'.$v->image?>">
								</object>
							</a>
						</div>
						<?php }}}} ?>
						...
						<div class="gr_comment">
							...
							<form action="" method="post">
								...
								<div class="bt_comment"><input onclick="return checkForm();" style="margin-right: 10px;" type="image" src="<?=PATH_URL_IMAGES.'static/images/bt_agree.gif'?>" /><input onclick="reset(); return false" type="image" src="<?=PATH_URL_IMAGES.'static/images/bt_reset.gif'?>" /></div>
							</form>
						</div>
						<?php } ?>
				...
				<div style="float: left; width: 160px;">
					...
					<div class="img_banner_right">
						<a onclick="clickBanner(<?=$v->id?>)" target="_blank" href="<?=$v->link?>"><img alt="2dep Banner Right Detail" src="<?=PATH_URL_IMAGES.'static/uploads/banner/'.$v->image?>" /></a>
					</div>
					<?php }else{ ?>
					<div class="img_banner_right">
						<a href="<?=$v->link?>" target="_blank" onclick="clickBanner(<?=$v->id?>)">
							<object width="160" height="600" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000">
								...
								<param value="transparent" name="wmode">
								<param value="high" name="quality">
								<embed width="160" height="600" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" quality="high" wmode="transparent" allowfullscreen="true" src="<?=PATH_URL_IMAGES.'static/uploads/banner/'.$v->image?>">
							</object>
						</a>
					</div>
					<?php }}}} ?>
