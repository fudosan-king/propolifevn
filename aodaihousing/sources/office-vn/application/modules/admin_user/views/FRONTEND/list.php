				<div class="left_content" style="background: #fff; width: 520px;">
					<div class="gr_list_news">
						...
						<div class="gr_item_list_news">
							<div class="item_image" onclick="location.href='<?=PATH_URL.SEOHTML($name_sub[0]->name).'/'.SEOHTML($name_cat[0]->name).'/'.$v->id.'/'.SEO($v->title)?>'" style="background: url(<?=PATH_URL_IMAGES.'static/uploads/news/medium/'.$v->image?>) center center no-repeat; width: 150px; height: 90px; cursor: pointer;"></div>
