...
<div class="table">
    ...
    <div class="row_text_field">
		<table cellspacing="0" cellpadding="0" border="0" width="100%">
			<tr>
				...
				<td class="right_text_field"><input value="<?php if(isset($result->link)) { print $result->link; }else{ print '';} ?>" type="text" name="linkAdmincp" /></td>
			</tr>
		</table>
	</div>
	...
	<div class="row_text_field">
		<table cellspacing="0" cellpadding="0" border="0" width="100%">
			<tr>
				<td class="left_text_field">Image(694×203):</td>
