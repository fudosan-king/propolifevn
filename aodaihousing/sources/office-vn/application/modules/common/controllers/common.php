...
//    public  $AREA_HOUSE=array('2'=>'quan_1','3'=>'le_thanh_ton','10'=>'quan_binhthanh','17'=>'quan_2','11'=>'quan_3','13'=>'quan_7_H','5'=>'quan_phunhuan','25'=>'quan_4','8'=>'quan_tanbinh','14'=>'quan_tanphu','22'=>'quan_govap','20'=>'quan_binhtan','12'=>'quan_5','23'=>'quan_6','24'=>'quan_8','27'=>'quan_9','18'=>'quan_10','19'=>'quan_11','21'=>'quan_12');
    public  $AREA_OFFICE=array('2'=>'quan_1','11'=>'quan_3','10'=>'quan_binhthanh','5'=>'quan_phunhuan','13'=>'quan_7','-1'=>'quan_khac');
    public  $AREA_HOUSE=array('10'=>'quan_binhthanh','17'=>'quan_2','13'=>'quan_7_H','2'=>'quan_1','3'=>'le_thanh_ton','11'=>'quan_3','25'=>'quan_4','5'=>'quan_phunhuan');
    ...
    public function search_option() {
        ...
        if(isset($_GET['opt'])) {
            ...
            if($data['table'] == 'offices'){
                ...
                $seoGoogle = array(
                    'keyword' => 'ホーチミンオフィス,ホーチミンオフィス賃貸,ホーチミンオフィス不動産'
                );
                $seo = array(
                    'title' => 'アオザイハウジング｜ホーチミンのオフィス検索',
                    'description' => 'ホーチミンのオフィスなら情報最大級のアオザイハウジングへ。仲介手数料にてご紹介。お問い合わせから、ご案内、契約フォローまで安心。日本人担当常駐'
                );
            }elseif($data['table'] == 'houses'){
                $data['itemAreas'] = $this->AREA_HOUSE;
                $seoGoogle = array(
                    'keyword' => 'ベトナム,ホーチミン,アパート,マンション,不動産,賃貸'
                );
                $seo = array(
                    'title' => 'アオザイハウジング｜ホーチミンのアパート・マンション検索',
                    'description' => 'ホーチミンのアパート・マンションの賃貸不動産なら最大級のアオザイハウジングへ。仲介手数料、更新手数料無料。お問い合わせのご対応から、ご案内、ご契約フォロー、入居後フォローまで日本語でサポート。'
                );
            }
        }else{
            $data['itemAreas'] = $this->AREA_HOUSE;
