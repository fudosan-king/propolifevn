                ...
                <div class="option-s">
                    <div class="option">
                        <div class="option-icon option-icon-1">
                            <span class="name-option">賃貸住宅</span>
                        ...
                        <div class="wrap-opt">
                            <div class="wrap-input">
                                <div id="areas" class="select_option">
                                    ...
                                    <?php if(!empty($itemAreas_H)): ?>
                                        <?php foreach($itemAreas_H as $key=>$item): ?>
                                            <?php
                                                $select = '';
                                                if($item->id == $localtion){
                                                    $select = 'selected';
                                ...
                                <div class="select_hide select_option">
                                    <select class="select_p" name="layout" style="width: 134px;">
                                ...
                                <div class="select_hide select_option">
                                    <select class="select_p" name="type" style="width: 134px;">
                                ...
                                <div class="select_hide select_option">
                                    <select class="select_p" name="rent" style="width: 134px;">
                        				<option value="">賃料</option>
                                        <?php 
                                            $data_option = array(
                                                '500' => '50㎡以下',
                                                '501-1000' => '501～1000USD',
                                                '1001-1500' => '1001～1500 USD'
                                            );
                                            foreach($data_option as $key=>$item){
                                                $select = '';
                                                if($key == $rent){
