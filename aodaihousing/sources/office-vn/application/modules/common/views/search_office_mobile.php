...
<div class="apartment-info">
    ...
    <div class="list-right">
        <div class="rent">
            ...
            <div class="w-2 w-100">
                <div><p><span class="label"><?php echo lang('rent'); ?>:</span> <?=!empty($item->month_rent)? vcp_printf($item->month_rent, current_lang_()). ' USD/'.lang('月'): ''; ?>
                        <?=!empty($item->size_rent) && !empty($item->month_rent)? ' - ':'';?>
                        <?=!empty($item->size_rent)? vcp_printf($item->size_rent, current_lang_()). ' USD/m&#178;':'';?></p></div>
