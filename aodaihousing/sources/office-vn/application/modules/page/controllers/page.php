...
class Page extends MX_Controller {
    ...
    public function page_vietnam_work_permits() {
        ...
        if(is_numeric($id) == false) {
            ...
            //$this->template->write('title',$item->title);
            $this->template->write_view('content','FRONTEND/page_vietnam_work_permits',$data);
            $this->template->render();
        }
    }
    ...
    public function page_jobs() {
        ...
        if(is_numeric($id) == false) {
            ...
            headerSeo($seo, $seoGoogle);        
            //$this->template->write('title',$item->title);
    		$this->template->write_view('content','FRONTEND/page_jobs',$data);
    		$this->template->render();
        }
    }
    public function page_support_content() {
        ...
        if(is_numeric($id) == false) {
            ...
            headerSeo($seo, $seoGoogle);        
            //$this->template->write('title',$item->title);
    		$this->template->write_view('content','FRONTEND/page_support_content',$data);
    		$this->template->render();
        }
    }
    ...
    public function page_industrial(){
        ...
        if(is_numeric($id) == false) {
            ...
            headerSeo($seo, $seoGoogle);        
            //$this->template->write('title',$item->title);
    		$this->template->write_view('content','FRONTEND/page_industrial',$data);
    		$this->template->render();
        }
    }
    ...
    public function page_advanced_support(){
        ...
        if(is_numeric($id) == false) {
            ...
            headerSeo($seo, $seoGoogle);        
            //$this->template->write('title',$item->title);
            $this->template->write_view('content','FRONTEND/page_advanced_support');
            $this->template->render();
        }
    }
    ...
    public function page_representative_office(){
        ...
        if(is_numeric($id) == false) {
            ...
            headerSeo($seo, $seoGoogle);        
            //$this->template->write('title',$item->title);
            $this->template->write_view('content','FRONTEND/page_representative_office',$data);
            $this->template->render();
        }
    }
