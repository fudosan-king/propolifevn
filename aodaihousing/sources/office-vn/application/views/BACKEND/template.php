...
<link rel="stylesheet" href="<?=PATH_URL.'static/css/admin/'?>styles.css?ver=3.8.2" type="text/css">
...
<link rel="stylesheet" href="<?=PATH_URL.'static/css/admin/'?>validationEngine.jquery.css?ver=3.8.2" type="text/css"/>
...
<script type="text/javascript" src="<?=PATH_URL.'static/js/admin/ajaxupload.3.5.js'?>"></script>
    <link rel="stylesheet" href="<?=PATH_URL?>static/plugin/fancybox/source/jquery.fancybox.css?ver=2.1.5" type="text/css" media="screen" />
...
<script type="text/javascript" src="<?=PATH_URL.'static/js/admin/admin.js?ver=2.1.5'?>"></script>
<script type="text/javascript" src="<?= PATH_URL ?>static/js/jscopy.js?ver=2.1.5"></script>
...
<div class="topNav">
	...
	<div class="userNav">
		<ul>
			<li class="profile"><a href="<?=PATH_URL.'admincp/update_profile'?>"><img alt="profile" src="<?=PATH_URL_IMAGES.'static/images/admin/userPic.png'?>" /><span><?=$this->session->userdata('userInfo')?></span></a></li>
			<li class="li_last_child"><a href="<?=PATH_URL.'admincp/logout'?>"><img alt="profile" src="<?=PATH_URL_IMAGES.'static/images/admin/logout.png'?>" /><span>Logout</span></a></li>
		</ul>
	</div>
</div>
<div class="header">
	<div class="logo"><img alt="" src="<?=PATH_URL_IMAGES.'static/images/admin/logo.png'?>" /></div>
