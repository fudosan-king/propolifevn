...
<html xmlns="http://www.w3.org/1999/xhtml">
 ...
 <meta name="robots" content="index, follow" />
        ...
        <link href='http://fonts.googleapis.com/css?family=Didact+Gothic&subset=latin,latin-ext' rel='stylesheet' type='text/css'>
            ...
            <link rel="stylesheet" type="text/css" href="<?= PATH_URL ?>static/css/slider.css?ver=3.8.2" />
            <script type="text/javascript" src="<?= PATH_URL ?>static/js/jquery-1.7.2.min.js"></script>
            <script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jqueryui/1.5.3/jquery-ui.min.js"></script>
            <script type="text/javascript" src="<?= PATH_URL ?>static/js/main.js?ver=2.1.5"></script>


            <link rel="stylesheet" type="text/css" href="<?= PATH_URL ?>static/css/base/advanced-slider-base.css" media="screen"/>
            <link rel="stylesheet" type="text/css" href="<?= PATH_URL ?>static/css/glossy-curved/black/glossy-curved-black.css" media="screen"/>
            <link rel="stylesheet" type="text/css" href="<?= PATH_URL ?>static/css/lightbox/prettyPhoto.css" media="screen"/>
            <link rel="stylesheet" type="text/css" href="<?= PATH_URL ?>static/css/lightbox-slider.css" media="screen"/>

            <!--[if IE 7]><link rel="stylesheet" type="text/css" href="../presentation-assets/presentation-ie7.css" media="screen"/><![endif]-->

            <!--[if IE]><script type="text/javascript" src="js/excanvas.compiled.js"></script><![endif]-->
            <script type="text/javascript" src="<?= PATH_URL ?>static/js/jquery.transition.min.js"></script>
            <script type="text/javascript" src="<?= PATH_URL ?>static/js/jquery.prettyPhoto.custom.min.js"></script>
            <script type="text/javascript" src="<?= PATH_URL ?>static/js/jquery.touchSwipe.min.js"></script>
            <script type="text/javascript" src="<?= PATH_URL ?>static/js/jquery.advancedSlider.min.js"></script>

            <!---->
            <script type="text/javascript" src="<?= PATH_URL ?>static/jcarousellite/jcarousellite_1.0.1.js?ver=2.1.5"></script>

            <link rel="stylesheet" type="text/css" href="<?= PATH_URL ?>static/jcarousellite/slide.css?ver=3.8.2" media="screen"/>
            <!---->
