...
Author: Peto hito
Author URI: http://propolife.co.jp
Plugin URI: http://propolife.co.jp
*/
...
wp_enqueue_style('farbtastic1', plugins_url('/css/farbtastic.css', __FILE__));
wp_enqueue_script('farbtastic1', plugins_url("/js/farbtastic.js", __FILE__));

wp_register_script('extra-funtions', plugins_url('/js/extra-field.js', __FILE__));
wp_enqueue_script('extra-funtions');
...
wp_register_script('gallery-funtions', plugins_url('/js/gallery-funtions.js', __FILE__));
wp_enqueue_script('gallery-funtions');

wp_register_script('gallery-upload', plugins_url('/js/gallery-upload.js', __FILE__));
...
add_meta_box($gallery['id'], $gallery['title'].' '.$large_size_w.' x '.$large_size_h.' pixel', 'gallery_show_box', $type, $gallery['context'], $gallery['priority']);
}
}
