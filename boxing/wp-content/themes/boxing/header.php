...
<head>
    ...
    <?php } else { ?>
        ...
        <?php  } else if ($lang == 'ja') { ?>
            ...
            <meta property="og:description" content="女性コースも充実。日本で人気のスポーツジムでの効率的なフィットネスバイク、ランニングマシン、ウェイトマシンのトレーニングと消費カロリーが高いボクシングエクササイズをベトナムホーチミン市でもご提供しております。">
            <meta name="description" content="女性コースも充実。日本で人気のスポーツジムでの効率的なフィットネスバイク、ランニングマシン、ウェイトマシンのトレーニングと消費カロリーが高いボクシングエクササイズをベトナムホーチミン市でもご提供しております。">
