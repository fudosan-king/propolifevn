...
<head>
    ...
    <?php } else { ?>
        ...
        <?php  } else if ($lang == 'ja') { ?>
            <title>サムライボクシングジム【公式】ホーチミン市でボクシングエクササイズ</title>
            <meta property="og:title" content="サムライボクシングジム │ ベトナムホーチミン市でボクシングエクササイズ">
            <meta property="og:description" content="ベトナムホーチミン市初の日系ボクシングジムです。日本で人気の消費カロリーが高いボクシングエクササイズと効率的なフィットネスバイク、ランニングマシン、ウェイトマシンでのトレーニングで汗を流せます。何かスポーツを始めたい、理想の体型を目指したいなどフィットネス目的の方から本格的にボクシングをしてみたいという方まで、ご年齢、性別問わずに楽しんで頂いております。">
            <meta name="description" content="ベトナムホーチミン市初の日系ボクシングジムです。日本で人気の消費カロリーが高いボクシングエクササイズと効率的なフィットネスバイク、ランニングマシン、ウェイトマシンでのトレーニングで汗を流せます。何かスポーツを始めたい、理想の体型を目指したいなどフィットネス目的の方から本格的にボクシングをしてみたいという方まで、ご年齢、性別問わずに楽しんで頂いております。">
            <meta name="keywords" content="ホーチミン,サムライボクシングジム,ジム,スポーツジム,フィットネス,ダイエット,ボクシング,ベトナム,公園,駐在,">
        <?php } else { ?>
