...
<head>
    ...
    <?php } else { ?>
        ...
        <?php  } else if ($lang == 'ja') { ?>
            <meta property="og:description" content="ベトナムホーチミン市初の日系ボクシングエクササイズジムです。消費カロリーが高い効果的な有酸素、無酸素エクササイズとフィットネスバイク、ランニングマシン、ウェイトマシンを利用した有酸素トレーニングで汗を流せます。何かスポーツを始めたい、理想の体型を目指したいなどフィットネス目的の方から本格的にボクシングをしてみたいという方まで、ご年齢、性別問わずに楽しんで頂けます。">
            <meta name="description" content="ベトナムホーチミン市初の日系ボクシングエクササイズジムです。消費カロリーが高い効果的な有酸素、無酸素エクササイズとフィットネスバイク、ランニングマシン、ウェイトマシンを利用した有酸素トレーニングで汗を流せます。何かスポーツを始めたい、理想の体型を目指したいなどフィットネス目的の方から本格的にボクシングをしてみたいという方まで、ご年齢、性別問わずに楽しんで頂けます。">
            <meta name="keywords" content="サムライボクシングジム,ホーチミン,ジム,スポーツ,フィットネス,汗を流す,ベトナム,公園,駐在,運動">
        <?php } else { ?>
