 ...
 */
add_action( 'woocommerce_before_main_content', 'woocommerce_breadcrumb_customer', 20, 0 );
add_action( 'woocommerce_before_main_content', 'woocommerce_add_header', 25, 0 );
...
add_action( 'woocommerce_archive_description', 'woocommerce_product_archive_description', 12 );
...
add_action( 'woocommerce_before_shop_loop_item_title', 'woocommerce_template_loop_product_thumbnail_customer', 10 );
add_action( 'woocommerce_shop_loop_item_title', 'woocommerce_template_loop_product_title', 10 );
add_action( 'woocommerce_after_shop_loop_item_title', 'woocommerce_template_loop_price_customer', 10 );
...
add_action( 'woocommerce_before_single_product_summary', 'woocommerce_add_header_product', 20 );
add_action( 'woocommerce_before_single_product_summary', 'woocommerce_show_product_images_customer', 25 );
...
// add_action( 'woocommerce_after_single_product_summary', 'woocommerce_product_thumbnails_customer', 30 );
add_action( 'woocommerce_after_single_product_summary', 'woocommerce_add_footer_product', 25 );
...
add_action( 'woocommerce_single_product_summary', 'woocommerce_single_product_summary_content', 5 );
...
add_action( 'woocommerce_single_product_summary', 'woocommerce_template_single_add_to_delivery', 35 );
