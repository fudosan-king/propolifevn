...
array('name' => 'Slogan','id' => $prefix . 'khau-hieu','type' => 'text','std' => 'Slogan'),
array('name' => 'Opening','id' => $prefix . 'open','type' => 'text','std' => 'Opening'),				  
...
array('name' => 'Website','id' => $prefix . 'web','type' => 'text','std' => 'Web'),
...
$lienhe["open"]=get_post_meta($post_id ,'open',true);
$lienhe["khauhieu"]=get_post_meta($post_id ,'khau-hieu',true);	
$lienhe["diachigmap"]=get_post_meta($post_id ,'dia-chi-gmap',true);
$lienhe["website"]=get_post_meta($post_id ,'web',true);
return $lienhe;
}
?>