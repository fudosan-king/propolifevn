...
html='<div class="meta-box-sortables ui-sortable" id="number_banner_'+num+'">'
html+='<div class="postbox">'
html+='<div class="handlediv" title="Click to toggle"><br></div>'

html+='<h3 class="hndle" id="title_banner_'+num+'"><span>Banner Slideshow '+num+'</span></h3>'
...
function delete_banner(num){
	$('#number_banner_'+num).fadeOut('slow');
	var str=$('input[name="binfo[arr_banner]"').val();
