...
//  $field_value = get_post_meta( $post->ID, '_wp_editor_mail_content', false );
  //wp_editor( $field_value[0], 'wp_editor_banner_content' );
// settings form 
?>
...
<div  id="post-body-content"><?php if($arrBanner!=''){include('slideshow-add-field.php');}?></div>
