...
<div class="meta-box-sortables ui-sortable" id="number_banner_<?php echo $i;?>">
<div class="postbox">
<div class="handlediv" title="Click to toggle"><br></div>

<h3 class="hndle" id="title_banner_<?php echo $i;?>"><span>Banner <?php echo $titlebanner; ?></span></h3>
