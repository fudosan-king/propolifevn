...
<div style="font-size:12px;">SKU:<?php echo get_post_meta($post->ID,'ma-sp',true);?></div>
<h4 class="offer-price" style="color: #c00;font-size:28px;">Price: <?php echo get_post_meta($post->ID,'gia-sp',true);?> VND</h4>
<div><span>数量: </span><input type="text" class="form-control input-sm" style="width:50px;"></div>
...
<div><span><?php echo __('GIÁ','ems'); ?>: <?php echo ($price!=''?number_format($price):0);?></span></div>
</div>
</div>
</div>
