...
if($value_meta !=''){
?>
<input type="text" readonly class="color_mcp" name="<?php echo $field['custom_type'][0]->giatri;?>" value="<?php echo $value_meta; ?>" style="background:<?php echo $value_meta?>;width:70px;"/>
<?php 
}
else{
?><input type="text" readonly class="color_mcp" name="<?php echo $field['custom_type'][0]->giatri;?>" value="<?php echo $value_meta; ?>" style="width:70px;"/>
<?php }?>                                                                                
