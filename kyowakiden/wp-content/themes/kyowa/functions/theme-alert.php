...
case '20': 
$header= 'Mail bị trùng';
$content='Địa chỉ mail này đã có người đăng ký, vui lòng chọn địa chỉ mail khác.';
$footer = '<button type="button" class="btn btn-default" data-dismiss="modal">Chọn mail khác</button><a href="'.home_url().'" class="btn btn-danger">Về trang chủ</a></div>';
break;
}
