                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                      <div class="box_info_staff">
                        ...
                        <p>特に進出支援におきましては、設立、ライセンス取得だけではなく、弊サービスでは設立期間中には会社運営上準備すべきこともサポートしており、ご担当者様から大変ご好評を頂いているサービスとなっております。</p>
                        <p>今後もベトナムでの手続きやベトナムでの生活に安心をご提供できるよう、サービスの向上に取り組んでまいります。</p>
                      </div>
                    </div>
                  </div>
