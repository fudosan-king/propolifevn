...
?>
	...
	<script src="<?php echo TEMPLATE_DIR; ?>/js/animsition.min.js"></script>
	<script src="<?php echo TEMPLATE_DIR; ?>/js/swiper.min.js"></script>
	<script src="<?php echo TEMPLATE_DIR; ?>/js/jquery.matchHeight-min.js"></script>
