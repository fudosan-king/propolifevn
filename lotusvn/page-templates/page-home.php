			...
			<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
				<div class="box_left">
					...
					<?php 
						if (have_rows('concept_content')):
							while(have_rows('concept_content')): the_row();
								...
								?>
								<h2 class="title"><i class="fa fa-question-circle-o" aria-hidden="true"></i><?php echo get_sub_field('concept_block_title'); ?></h2>
					...
					<?php 
						if (have_rows('feature_content')):
							while(have_rows('feature_content')): the_row();
								echo '<h2 class="title"><i class="fa fa-info-circle" aria-hidden="true"></i>'.get_sub_field('title').'</h2>';
					...
					<?php 
						...
						if (have_rows('responsible_content')):
							echo '<div class="row">';
							while(have_rows('responsible_content')): the_row();
								...
								<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
									<article class="service_item">
										...
										<div class="box_content_top">
											<h3><a href="#"><?php echo $member_pos_name; ?></a></h3>
											<p><?php echo get_sub_field('text_area'); ?></p>
										</div>
									</article>
								</div>
