	...
	<div class="parttern">
		<div class="container" align="center">
			...
			<div class="row">
				...
				<?php
				$gallery_demo = get_field('interior_demo_gallery', 'option');
				foreach ($gallery_demo as $key => $obj) {
					$imgUrl = wp_get_attachment_image_url( $obj['ID'], $size = 'large', $icon = false );
					?>
					<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
						<div class="thumbnail interior" align="center">
							<a href="<?php echo $imgUrl; ?>" class="fancybox-buttons centerIn" data-fancybox-group="button">
								<img  src="<?php echo $imgUrl; ?>" class="img-responsive resize wp-post-image" alt="" onload="imgLoaded(this)" srcset="<?php echo $imgUrl; ?>" ">
							</a>
						</div>
					</div>
					<?php
