...
<meta name="Keywords" content="藤和シティコープ,飛鳥山公園,王子駅,滝野川一丁目駅,東京都北区,マンション,中古マンション,購入" />
<meta name="Description" content="王子駅近く「藤和シティコープ飛鳥山公園」マンション購入なら、スター・マイカ・レジデンス株式会社" />
<title>藤和シティコープ飛鳥山公園｜中古マンション購入ならスター・マイカ・レジデンス株式会社</title>
...
<div id="header">
  <div class="clear-box">
    <h1><a href="http://www.starmica-r.co.jp/asukayama/index.html"><img src="img/base_logo.gif" alt="藤和シティコープ飛鳥山公園 ｜中古マンション購入なら、スター・マイカ・レジデンス株式会社" width="289" height="59" /></a></h1>
        <div class="right">
          <ul id="mini-navi">
		<li><a href="http://www.starmica-r.co.jp/asukayama/access.html#a2"><img src="img/mini-navi_1_off.gif" alt="現地案内図" width="68" height="13" /></a></li>
		<li><a href="http://www.starmica-r.co.jp/asukayama/gaiyou.html"><img src="img/mini-navi_3_off.gif" alt="物件概要" width="56" height="13" /></a></li>
		<li><a href="http://www.starmica-r.co.jp/aboutus.php" target="_blank"><img src="img/mini-navi_2_off.gif" alt="会社情報" width="56" height="13" /></a></li>
          </ul>
          <div class="phone"><a href="https://www.starmica-r.co.jp/asukayama/contactus.php"><img src="img/base_btn_contact.jpg" alt="お問い合わせ・資料請求" width="189" height="30" /></a></div>
        </div>
...
<div id="globalnavi">
  <ul>
    <li><a href="http://www.starmica-r.co.jp/asukayama/index.html"><img src="img/globalnavi_1.gif" alt="ホーム" width="182" height="40" /></a></li>
    <li><a href="http://www.starmica-r.co.jp/asukayama/madori.html"><img src="img/globalnavi_2.gif" alt="間取り" width="179" height="40" /></a></li>
    <li><a href="http://www.starmica-r.co.jp/asukayama/syuhen.html"><img src="img/globalnavi_3.gif" alt="周辺環境" width="179" height="40" /></a></li>
    <li><a href="http://www.starmica-r.co.jp/asukayama/access.html"><img src="img/globalnavi_4.gif" alt="アクセス" width="181" height="40" /></a></li>
    <li><a href="http://www.starmica-r.co.jp/asukayama/shisetu.html"><img src="img/globalnavi_5.gif" alt="共用施設案内" width="179" height="40" /></a></li>
  </ul>
</div>
<!--/globalnavi-->
<hr />
<div id="bukken" class="page1">
  <div id="wrapper">
    <div id="title-area900">
      <h2><img src="img/toiawase_title.jpg" alt="藤和シティーコーポ飛鳥山公園 お問い合わせ・資料請求" width="900" height="140" /></h2>
      <div id="bread-crumb">
        <ul>
          <li><a href="http://www.starmica-r.co.jp/asukayama/index.html">ホーム</a></li>
          <li class="arrow">お問い合わせ・資料請求</li>
        </ul>
      </div>
      <!--/bread-crumb-->
    </div>
    ...
    <div id="container900">
      <div id="content900">
        <h3 class="main-title"><span>お問い合わせ・資料請求</span></h3>
...
<div id="footer">
  <div class="item2">
    <div class="clear-box">
    <ul>
        <li class="first"><a href="http://www.starmica-r.co.jp/asukayama/index.html">ホーム</a></li>
        <li><a href="http://www.starmica-r.co.jp/asukayama/access.html#a2">現地案内図</a></li>
        <li><a href="http://www.starmica-r.co.jp/asukayama/gaiyou.html">物件概要</a></li>
        <li><a href="http://www.starmica-r.co.jp/privacy.php" target="_blank">個人情報保護方針</a></li>
        <li><a href="https://www.starmica-r.co.jp/asukayama/contactus.php">お問い合わせ</a></li>
    </ul>
...
elseif($errmsg !=1 AND $_POST['sendgo']){
	...
	$oubosubject = "藤和シティコープ飛鳥山公園ＨＰよりお問い合わせ";
	$oubomessage = <<<_EOT_
...
<div id="bukken" class="page1">
  <div id="wrapper">
    <div id="title-area900">
      <h2><img src="img/toiawase_title.jpg" alt="藤和シティコープ飛鳥山公園 お問い合わせ・資料請求" width="900" height="140" /></h2>
      <div id="bread-crumb">
        <ul>
          <li><a href="http://www.starmica-r.co.jp/asukayama/index.html">ホーム</a></li>
          <li class="arrow">お問い合わせ・資料請求</li>
...
?>
					...
					<TEXTAREA name="e_soudan" style="width:470px" rows="10" TABINDEX="6"><?=$e_soudan?></TEXTAREA>
					</td>
					</tr>
<?php
	if($e_naiyou_msg){
...
?>
					...
					<input type="text" name="e_name" style="width:350px" value="<?=$e_name?>" TABINDEX="7">&nbsp;（例）港区　一郎
					</td>
					</tr>
<?php
	if($e_name_msg){
...
?>
					...
					フリガナ<span class="style7">※</span></td>
					<td width="550" class="tb2" bgcolor="#ffffff">
					<input type="text" name="e_namekana" style="width:350px" value="<?=$e_namekana?>" TABINDEX="8">&nbsp;（例）ミナトク　イチロウ
					</td>
					</tr>
<?php
	if($e_namekana_msg){
...
?>
					...
					メールアドレス<span class="style7">※</span></td>
					<td width="550" class="tb2">
					<input type="text" name="e_mail" style="width:350px" value="<?=$e_mail?>" style="ime-mode:disabled" TABINDEX="9">&nbsp;（例）info@starmica-r.co.jp
					</td>
					</tr>
<?php
	if($e_mail_msg){
...
?>
					...
					<td width="550" class="tb2">
					<input type="text" name="e_mail2" style="width:350px" value="<?=$e_mail2?>" style="ime-mode:disabled" TABINDEX="10">&nbsp;（例）info@starmica-r.co.jp
					</td>
					</tr>
<?php
	if($e_mail2_msg){
...
?>
					...
					電話番号<span class="style7">※</span></td>
					<td width="550" class="tb2" bgcolor="#ffffff">
					<input type="text" name="e_tel" style="width:250px" value="<?=$e_tel?>" TABINDEX="13">&nbsp;（例）03-5776-2688
					</td>
					</tr>
<?php
	if($e_tel_msg){
...
?>
					...
					FAX番号</td>
					<td width="550" class="tb2" bgcolor="#ffffff">
					<input type="text" name="e_fax" style="width:250px" value="<?=$e_fax?>" TABINDEX="14">&nbsp;（例）03-1234-5678
					</td>
					</tr>
<?php
	if($e_fax_msg){
...
?>
					...
					生年月日<span class="style7">※</span></td>
					<td width="550" class="tb2" bgcolor="#ffffff">
					<input type="text" name="e_birthday" style="width:250px" value="<?=$e_birthday?>" TABINDEX="15">&nbsp;（例）1980/01/01
					</td>
					</tr>
<?php
	if($e_birthday_msg){
