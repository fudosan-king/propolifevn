			...
			<div class="row">
				<div id="content" class="col third-fourth right">
					<section id="sec01">
						...
						<img src="images/contactus-step02_on.png" width="680" height="100"/>
						<p class="bottom-10">
				...
				<div class="top-10">
						...
						<tr> 
						<th class="tablemidashi" colspan="2">お問い合わせ項目<span class="icon-required">必須</span>
						</th>
						</tr>
						<tr>
						<td colspan="2">
...
?>
						...
						<th>
						ご住所<span class="icon-required">必須</span></th>
						<td><?=$e_address2?></td>
						</tr>
						<tr> 
						<th>
						ご連絡方法<span class="icon-required">必須</span></th>
						<td>
<?php
...
お客さまのお問い合せ情報の送信完了いたしました。
担当者より順次ご連絡をさせていただきますので今しばらくお待ちください。


定休日（毎週火・水曜日及び祝日）受付の場合には翌営業日以降の対応となりますのでご了承ください。
			...
			<div class="row">
				<div id="content" class="col third-fourth right">
					<section id="sec01">
						...
						<img src="images/contactus-step01_on.png" width="680" height="100"/>
						<FORM method="post" action="contactus.php">
						<table class="formTable">
						<tr> 
...
?>
						...
						お名前<span class="icon-required">必須</span></th>
						<td>
						<input type="text" name="e_name" value="<?=$e_name?>" style="width:50%" placeholder="例：田中一郎" class="form-control">
...
?>
						...
						Eメール<span class="icon-required">必須</span></th>
						<td>
						<input type="text" name="e_mail" style="width:50%;ime-mode:disabled" value="<?=$e_mail?>" placeholder="例：info@starmica-r.co.jp" class="form-control">
...
?>
						...
						<tr> 
						<th>
						Eメール確認<span class="icon-required">必須</span></th>
						<td>
						<input type="text" name="e_mail" style="width:50%;ime-mode:disabled" value="<?=$e_mail?>" placeholder="例：info@starmica.jp" class="form-control">
						<span class="supportmsg">半角英数（例：info@smr.jp）</span>
<?php
		if($e_mail_msg){
?>
