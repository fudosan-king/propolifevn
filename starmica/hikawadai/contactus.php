...
<meta name="Keywords" content="ステラレジデンス氷川台,ステラレジデンス,マンション,中古マンション,分譲マンション,有楽町線,副都心線,東武東上線,氷川台駅,氷川台," />
<meta name="Description" content="ステラレジデンス氷川台は、中古マンション販売専門のスター・マイカ・レジデンスがおすすめする国立駅周辺の大規模マンション物件です。" />
...
<div id="header">
	<div class="clear-box">
		<div class="left">
	    		<div class="header-copy">テラレジデンス氷川台　東京メトロ有楽町線・副都心線「氷川台」駅徒歩10分</div>
		</div>
		<div class="right">
          		<ul id="mini-navi">
			<li><a href="location.php#map"><img src="img/mininavi_1.gif" alt="現地案内図" width="71" height="13" /></a></li>
			<li><a href="http://www.starmica-r.co.jp/corprateprofile.php" target="_blank"><img src="img/mininavi_2.gif" alt="会社情報" width="58" height="13" /></a></li>
			</ul>
		</div>
        </div>
	<div class="logo">
	    <h1><a href="index.php"><img src="img/header-logo.png" alt="ステラレジデンス氷川台" width="159" height="82" /></a></h1>
	</div>
</div>
<!--/header-->
<div id="globalnavi">
   <ul>
    <li><a href="http://www.starmica-r.co.jp/hikawadai/index.php"><img src="img/globalnavi_1.png" alt="ホーム" width="150" height="80" /></a></li>
    <li><a href="http://www.starmica-r.co.jp/hikawadai/location.php"><img src="img/globalnavi_2.png" alt="周辺環境" width="150" height="80" /></a></li>
    <li><a href="http://www.starmica-r.co.jp/hikawadai/plan.php"><img src="img/globalnavi_3.png" alt="間取り" width="150" height="80" /></a></li>
    <li><a href="http://www.starmica-r.co.jp/hikawadai/access.php"><img src="img/globalnavi_4.png" alt="アクセス" width="150" height="80" /></a></li>
    <li><a href="http://www.starmica-r.co.jp/hikawadai/gaiyou.php"><img src="img/globalnavi_5.png" alt="物件概要" width="150" height="80" /></a></li>
    <li><a href="https://www.starmica-r.co.jp/hikawadai/contactus.php"><img src="img/globalnavi_6_on.png" alt="資料請求・お問い合わせ" width="150" height="80" /></a></li>
   </ul>
</div>
<!--/globalnavi-->
<hr />
<div id="bukken" class="page1">
  <div id="wrapper">
    <div id="title-area">
	<div class="title"><img src="img/pagetitle-05.png" alt="資料請求・お問い合わせ" width="900" height="64" /></div>
	<div id="bread-crumb">
	        <ul>
	          <li><a href="http://www.starmica-r.co.jp/hikwadai/index.php">ホーム</a></li>
    ...
    <div id="container">
      <div id="content">
		...
		<p class="bottom-15 top-10">
            		<b>ご入力いただいた内容をご確認の上、送信ボタンをクリックしてください。</b>
		</p>
        </div>
        <div class="bottom-20">
				<FORM method="post" action="">
					...
					<tr> 
					<td width="350" class="tb2-l" rowspan="2">
					お問い合わせ内容（複数選択可）<span class="style7">※</span></td>
					<td width="550" class="tb1">
<?php
	if($e_naiyou1 == 't'){
...
<br>
					...
					<td class="tb1-c"> 
当社の個人情報の取扱いについては<a href="http://www.starmica-r.co.jp/privacy.php" target="_blank"><b>こちら</b></a>（別ウィンドウ）をご覧ください。<br>
上記「<a href="http://www.starmica-r.co.jp/privacy.php" target="_blank"><b>『個人情報の取り扱い』</b></a>の内容に同意される方は、下記<b> [同意して送信] </b>のボタンをクリックして下さい。
					</td>
					</tr>
					<tr> 
  	...
  	<div class="inr">
	    <div class="clear-box">
		    <ul>
		        ...
		        <li><a href="https://www.starmica-r.co.jp/hikawadai/contactus.php">お問い合わせ</a></li>
		    </ul>
	    ...
	    <div class="footer-banner">
	          <ol>
			<li><a href="http://www.starmica-r.co.jp/" target="_blank"><img src="img/resi_logo2.jpg" alt="スター・マイカ・レジデンス株式会社" width="304" height="53" /></a></li>
			<li><a href="http://www.starmica.co.jp/" target="_blank"><img src="img/mica_logo.jpg" alt="スター・マイカ株式会社" width="258" height="53" /></a></li>
...
<div id="bukken" class="page1">
  <div id="wrapper">
	...
	<div id="bread-crumb">
		<ul>
	          <li><a href="http://www.starmica-r.co.jp/hikawadai/index.php">ホーム</a></li>
	          <li class="arrow">お問い合わせ</li>
	        </ul>
	</div>
	<!--/bread-crumb-->
    ...
    <div id="container">
        ...
        <div class="sec1 bottom-20">
	          <div class="top-30">
		            <b>下記項目をご入力ください。尚、<span class="style7">※</span>印は必須項目となっております。</b>
		   </div>
           <p class="bottom-20">
				<FORM method="post" action="">
...
?>
					...
					<tr> 
					<td class="tb1">
					<TEXTAREA name="e_soudan" style="width:450px" rows="10" TABINDEX="6"><?=$e_soudan?></TEXTAREA>
					</td>
					</tr>
<?php
	if($e_naiyou_msg){
?>
					<tr>
					<td class="tb1" colspan="2" bgcolor="#FFFFFF">
					<span class="style7"><?=$e_naiyou_msg?></span>
			                </td>
					</tr>
<?php
	}
...
?>
					<tr>
					<td class="tb1" colspan="2" bgcolor="#FFFFFF">
					<span class="style7"><?=$e_soudan_msg?></span>
			                </td>
					</tr>
<?php
	}
?>
					...
					<td width="350" class="tb2-l"> 
					お名前<span class="style7">※</span></td>
					<td width="550" class="tb1" bgcolor="#ffffff">
...
?>
					<tr>
					<td class="tb1" colspan="2" bgcolor="#FFFFFF">
					<span class="style7"><?=$e_name_msg?></span>
			                </td>
					</tr>
<?php
	}
...
?>
					<tr>
					<td class="tb1" colspan="2" bgcolor="#FFFFFF">
					<span class="style7"><?=$e_namekana_msg?></span>
			                </td>
					</tr>
<?php
	}
?>
					...
					メールアドレス<span class="style7">※</span></td>
					<td width="550" class="tb1">
					<input type="text" name="e_mail" style="width:400px; ime-mode:disabled" value="<?=$e_mail?>" TABINDEX="9">&nbsp;（例）smr@starmica.co.jp
					</td>
					</tr>
<?php
	if($e_mail_msg){
?>
					<tr>
					<td class="tb1" colspan="2" bgcolor="#FFFFFF">
					<span class="style7"><?=$e_mail_msg?></span>
			                </td>
					</tr>
<?php
	}
?>
					<tr> 
					<td width="350"  class="tb2-l">
					メールアドレス<br>（確認のためもう一度入力して下さい）<span class="style7">※</span></td>
					<td width="550" class="tb1">
					<input type="text" name="e_mail2" style="width:400px; ime-mode:disabled" value="<?=$e_mail2?>" TABINDEX="10">&nbsp;（例）smr@starmica.co.jp
					</td>
					</tr>
<?php
	if($e_mail2_msg){
?>
					<tr>
					<td class="tb1" colspan="2" bgcolor="#FFFFFF">
					<span class="style7"><?=$e_mail2_msg?></span>
			                </td>
					</tr>
<?php
	}
...
?>
					<tr>
					<td class="tb1" colspan="2" bgcolor="#FFFFFF">
					<span class="style7"><?=$e_yubin_msg?></span>
			                </td>
					</tr>
<?php
	}
...
?>
					<tr>
					<td class="tb1" colspan="2" bgcolor="#FFFFFF">
					<span class="style7"><?=$e_address_msg?></span>
			                </td>
					</tr>
<?php
	}
...
?>
					<tr>
					<td class="tb1" colspan="2" bgcolor="#FFFFFF">
					<span class="style7"><?=$e_tel_msg?></span>
			                </td>
					</tr>
<?php
	}
...
?>
					<tr>
					<td class="tb1" colspan="2" bgcolor="#FFFFFF">
					<span class="style7"><?=$e_fax_msg?></span>
			                </td>
					</tr>
<?php
	}
...
?>
					<tr>
					<td class="tb1" colspan="2" bgcolor="#FFFFFF">
					<span class="style7"><?=$e_birthday_msg?></span>
			                </td>
					</tr>
<?php
	}
...
?>
					<tr>
					<td class="tb1" colspan="2" bgcolor="#FFFFFF">
					<span class="style7"><?=$e_sumai_msg?></span>
			                </td>
					</tr>
<?php
	}
...
?>
					<tr>
					<td class="tb1" colspan="2" bgcolor="#FFFFFF">
					<span class="style7"><?=$e_sagashi_msg?></span>
			                </td>
					</tr>
<?php
	}
...
?>
					<tr>
					<td class="tb1" colspan="2" bgcolor="#FFFFFF">
					<span class="style7"><?=$e_kikkake_msg?></span>
			                </td>
					</tr>
<?php
	}
...
?>
					<tr>
					<td class="tb1" colspan="2" bgcolor="#FFFFFF">
					<span class="style7"><?=$e_melmaga_msg?></span>
			                </td>
					</tr>
<?php
	}
