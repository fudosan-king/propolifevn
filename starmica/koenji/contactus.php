...
<div id="header">
  <div class="clear-box">
        <div class="left">
    		<h1><a href="http://www.starmica-r.co.jp/koenji/index.php"><img src="img/header_logo.gif" alt="ステラレジデンス高円寺" width="421" height="70" /></a></h1>
	</div>
        <div class="right">
          <ul id="mini-navi">
		<li><a href="http://www.starmica-r.co.jp/koenji/location.php#map"><img src="img/mininavi_1.gif" alt="現地案内図" width="80" height="16" /></a></li>
...
<div id="globalnavi">
   <ul>
    <li><a href="http://www.starmica-r.co.jp/koenji/index.php"><img src="img/globalnavi_1.gif" alt="ホーム" width="150" height="44" /></a></li>
    <li><a href="http://www.starmica-r.co.jp/koenji/plan.php"><img src="img/globalnavi_2.gif" alt="間取り" width="150" height="44" /></a></li>
    <li><a href="http://www.starmica-r.co.jp/koenji/equipment.php"><img src="img/globalnavi_6.gif" alt="設備・仕様" width="150" height="44" /></a></li>
    <li><a href="http://www.starmica-r.co.jp/koenji/access.php"><img src="img/globalnavi_3.gif" alt="アクセス" width="150" height="44" /></a></li>
    <li><a href="http://www.starmica-r.co.jp/koenji/location.php"><img src="img/globalnavi_4.gif" alt="周辺環境" width="150" height="44" /></a></li>
    <li><a href="http://www.starmica-r.co.jp/koenji/gaiyou.php"><img src="img/globalnavi_5.gif" alt="物件概要" width="150" height="44" /></a></li>
   </ul>
</div>
<!--/globalnavi-->
<hr />
<div id="bukken" class="page1">
  <div id="wrapper">
    <div id="title-area900">
      <div id="bread-crumb">
        <ul>
          <li><a href="http://www.starmica-r.co.jp/koenji/index.php">ホーム</a></li>
...
<div id="footer">
  <div class="item2">
  	<div class="item3">
	    <div class="clear-box">
	    <ul>
	        <li class="first"><a href="http://www.starmica-r.co.jp/koenji/index.php">ホーム</a></li>
	        <li><a href="http://www.starmica-r.co.jp/koenji/access.php#map">現地案内図</a></li>
	        <li><a href="http://www.starmica-r.co.jp/koenji/gaiyou.php">物件概要</a></li>
...
elseif($errmsg !=1 AND $_POST['sendgo']){
	...
	$oubosubject = "ステラレジデンス高円寺ＨＰよりお問い合わせ";
	$oubomessage = <<<_EOT_
...
?>
					...
					メールアドレス<span class="style7">※</span></td>
					<td width="530" class="tb2">
					<input type="text" name="e_mail" style="width:350px; ime-mode:disabled" value="<?=$e_mail?>" TABINDEX="9">&nbsp;（例）smr@starmica.co.jp
					</td>
					</tr>
<?php
	if($e_mail_msg){
...
?>
					...
					<td width="530" class="tb2">
					<input type="text" name="e_mail2" style="width:350px; ime-mode:disabled" value="<?=$e_mail2?>" TABINDEX="10">&nbsp;（例）smr@starmica.co.jp
					</td>
					</tr>
<?php
	if($e_mail2_msg){
