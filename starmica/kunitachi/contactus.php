...
<div id="header">
  ...
  <div class="clear-box">
        <div class="left">
    		<h1><a href="http://www.starmica-r.co.jp/kunitachi/index.php"><img src="img/header_logo.gif" alt="クリオレミントンヴィレッジ国立イーストコート" width="420" height="52" /></a></h1>
	</div>
        <div class="right">
          <ul id="mini-navi">
		<li><a href="http://www.starmica-r.co.jp/kunitachi/access.php#map"><img src="img/mininavi_1.gif" alt="現地案内図" width="80" height="16" /></a></li>
...
<div id="globalnavi">
   <ul>
    <li><a href="http://www.starmica-r.co.jp/kunitachi/index.php"><img src="img/globalnavi_1.gif" alt="ホーム" width="180" height="42" /></a></li>
    <li><a href="http://www.starmica-r.co.jp/kunitachi/plan.php"><img src="img/globalnavi_2.gif" alt="お部屋・プラン" width="180" height="42" /></a></li>
    <li><a href="http://www.starmica-r.co.jp/kunitachi/kyouyou.php"><img src="img/globalnavi_3.gif" alt="共用施設" width="180" height="42" /></a></li>
    <li><a href="http://www.starmica-r.co.jp/kunitachi/access.php"><img src="img/globalnavi_4.gif" alt="環境・アクセス" width="180" height="42" /></a></li>
    <li><a href="http://www.starmica-r.co.jp/kunitachi/gaiyou.php"><img src="img/globalnavi_5.gif" alt="物件概要" width="180" height="42" /></a></li>
   </ul>
</div>
<!--/globalnavi-->
<hr />
<div id="bukken" class="page1">
  <div id="wrapper">
    <div id="title-area900">
      <div id="bread-crumb">
        <ul>
          <li><a href="http://www.starmica-r.co.jp/kunitachi/index.php">ホーム</a></li>
    ...
    <!--/title-area-->
    <div id="container900">
	<div class="title"><img src="img/contact_title.gif" alt="お問い合わせ" width="900" height="32" /></div>
...
<div id="footer">
  <div class="item2">
  	<div class="item3">
	    <div class="clear-box">
	    <ul>
	        <li class="first"><a href="http://www.starmica-r.co.jp/kunitachi/index.php">ホーム</a></li>
	        <li><a href="http://www.starmica-r.co.jp/kunitachi/access.php#map">現地案内図</a></li>
	        <li><a href="http://www.starmica-r.co.jp/kunitachi/gaiyou.php">物件概要</a></li>
