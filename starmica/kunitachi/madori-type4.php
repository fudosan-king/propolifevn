...
<div id="header2">
  <div class="clear-box">
		...
		<li><a href="http://www.starmica-r.co.jp/corprateprofile.php" target="_blank"><img src="img/mininavi_2.gif" alt="会社情報" width="80" height="16" /></a></li>
          ...
          <div class="phone"><a href="contactus.php"><img src="img/toiawase.gif" alt="お問い合わせ・資料請求" width="183" height="31" /></a></div>
        </div>
...
<div class="sec2">
    <div class="bukken700">
            <div class="item-title">
              <h5><img src="img/madori-title618.gif" alt="618号室　3LDK　4,790万円" width="672" height="38" /></h5>
            </div>
            <!--/item-title-->

		<div class="dai-photowaku">
		<img src="img/madori_618.jpg" alt="間取り図" width="630" height="600" />
		</div>
		<div class="bukken">
		■管理費 11,530円/月&nbsp; &nbsp;■修繕積立金 15,630円/月&nbsp; &nbsp;■所在階 6階
		</div>
<br>
        <div class=bottom-20">
	<center>
