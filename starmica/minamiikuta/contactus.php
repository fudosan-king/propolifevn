...
<meta name="Keywords" content="ステラガーデン南生田,小田急,小田原線,生田駅,生田,川崎,南生田,マンション,中古マンション,購入" />
<meta name="Description" content="小田急小田原線『生田駅』徒歩12分の「ステラガーデン南生田」のマンション購入に関する相談なら、スター・マイカ・レジデンス株式会社" />
...
<div id="header">
  <div class="clear-box">
        <div class="left">
<h3>ステラガーデン南生田は、小田急小田原線『生田駅』徒歩12分の分譲マンション。</h3>
    <h1><a href="http://www.starmica-r.co.jp/minamiikuta/index.php"><img src="img/base_logo.gif" alt="ステラガーデン南生田 ｜スター・マイカ・レジデンス株式会社" width="260" height="56" /></a></h1>
	</div>	
        <div class="right">
          <ul id="mini-navi">
		<li><a href="http://www.starmica-r.co.jp/minamiikuta/access.php#a2"><img src="img/mini-navi_1_off.gif" alt="現地案内図" width="68" height="13" /></a></li>
		<li><a href="http://www.starmica-r.co.jp/minamiikuta/gaiyou.php"><img src="img/mini-navi_2_off.gif" alt="物件概要" width="56" height="13" /></a></li>
		<li><a href="http://www.starmica-r.co.jp/corprateprofile.php" target="_blank"><img src="img/mini-navi_3_off.gif" alt="会社情報" width="56" height="13" /></a></li>
          </ul>
          <div class="phone"><a href="https://www.starmica-r.co.jp/minamiikuta/contactus.php"><img src="img/toiawase.gif" alt="お問い合わせ・資料請求" width="189" height="30" /></a></div>
        </div>
...
<?php
	if($currentmenu == '1'){
?>
    <li><a href="http://www.starmica-r.co.jp/minamiikuta/index.php"><img src="img/globalnavi_1_on.gif" alt="ホーム" width="182" height="40" /></a></li>
<?php
	}
	else{
?>
    <li><a href="http://www.starmica-r.co.jp/minamiikuta/index.php"><img src="img/globalnavi_1.gif" alt="ホーム" width="182" height="40" /></a></li>
<?php
	}
	if($currentmenu == '2'){
?>
    <li><a href="http://www.starmica-r.co.jp/minamiikuta/madori.php"><img src="img/globalnavi_2_on.gif" alt="間取りプラン" width="179" height="40" /></a></li>
<?php
	}
	else{
?>
    <li><a href="http://www.starmica-r.co.jp/minamiikuta/madori.php"><img src="img/globalnavi_2.gif" alt="間取りプラン" width="179" height="40" /></a></li>
<?php
	}
	if($currentmenu == '3'){
?>
    <li><a href="http://www.starmica-r.co.jp/minamiikuta/shisetu.php"><img src="img/globalnavi_3_on.gif" alt="施設案内" width="179" height="40" /></a></li>
<?php
	}
	else{
?>
    <li><a href="http://www.starmica-r.co.jp/minamiikuta/shisetu.php"><img src="img/globalnavi_3.gif" alt="施設案内" width="179" height="40" /></a></li>
<?php
	}
	if($currentmenu == '4'){
?>      
    <li><a href="http://www.starmica-r.co.jp/minamiikuta/syuhen.php"><img src="img/globalnavi_4_on.gif" alt="周辺環境" width="179" height="40" /></a></li>
<?php
	}
	else{
?>
    <li><a href="http://www.starmica-r.co.jp/minamiikuta/syuhen.php"><img src="img/globalnavi_4.gif" alt="周辺環境" width="179" height="40" /></a></li>
<?php
	}
	if($currentmenu == '5'){
?> 
    <li><a href="http://www.starmica-r.co.jp/minamiikuta/access.php"><img src="img/globalnavi_5_on.gif" alt="アクセス" width="181" height="40" /></a></li>
<?php
	}
	else{
?>
    <li><a href="http://www.starmica-r.co.jp/minamiikuta/access.php"><img src="img/globalnavi_5.gif" alt="アクセス" width="181" height="40" /></a></li>
...
<div id="bukken" class="page1">
  <div id="wrapper">
    <div id="title-area900">
      <h2><img src="img/otoiawase_title.jpg" alt="お問い合わせ" width="900" height="70" /></h2>
      <div id="bread-crumb">
        <ul>
          <li><a href="http://www.starmica-r.co.jp/minamiikuta/index.php">ホーム</a></li>
...
<div id="footer">
  <div class="item2">
    <div class="clear-box">
    <ul>
         <li class="first"><a href="http://www.starmica-r.co.jp/minamiikuta/index.php">ホーム</a></li>
        <li><a href="http://www.starmica-r.co.jp/minamiikuta/access.php#a2">現地案内図</a></li>
        <li><a href="http://www.starmica-r.co.jp/minamiikuta/gaiyou.php">物件概要</a></li>
        <li><a href="http://www.starmica-r.co.jp/privacy.php" target="_blank">個人情報保護方針</a></li>
        <li><a href="https://www.starmica-r.co.jp/minamiikuta/contactus.php">お問い合わせ</a></li>
        <li></li>
<br>
<a href="https://www.starmica-r.co.jp/minamiikuta/contactus.php" target="_blank"><img src="img/fan_base_logo.gif" alt="フリーダイヤル" width="375" height="41" /></a>
    </ul>
    <p class="copy">
<a href="https://www.starmica-r.co.jp/minamiikuta/contactus.php"><img src="img/feetel.gif" alt="フリーダイヤル" width="331" height="59" /></a>
</p>
    </div>
    <!--clear-box-->
  </div>
...
<script type="text/javascript">
  ...
  var _gaq = _gaq || [];
  _gaq.push(['_setAccount', 'UA-19640586-1']);
...
elseif($errmsg !=1 AND $_POST['sendgo']){
	...
	$oubosubject = "ステラガーデン南生田ＨＰよりお問い合わせ";
	$oubomessage = <<<_EOT_
...
?>
					...
					メールアドレス<span class="style7">※</span></td>
					<td width="530" class="tb2">
					<input type="text" name="e_mail" style="width:300px; ime-mode:disabled" value="<?=$e_mail?>" TABINDEX="9">&nbsp;（例）info@starmica-r.co.jp
					</td>
					</tr>
<?php
	if($e_mail_msg){
...
?>
					...
					<td width="530" class="tb2">
					<input type="text" name="e_mail2" style="width:300px; ime-mode:disabled" value="<?=$e_mail2?>" TABINDEX="10">&nbsp;（例）info@starmica-r.co.jp
					</td>
					</tr>
<?php
	if($e_mail2_msg){
...
?>
					...
					郵便番号<span class="style7">※</span></td>
					<td width="530" class="tb2" bgcolor="#ffffff">
					<input type="text" name="e_yubin" style="width:300px" value="<?=$e_yubin?>" TABINDEX="11">&nbsp;（例）105-6028 
					</td>
					</tr>
<?php
	if($e_yubin_msg){
...
?>
					...
					電話番号<span class="style7">※</span></td>
					<td width="530" class="tb2" bgcolor="#ffffff">
					<input type="text" name="e_tel" style="width:300px" value="<?=$e_tel?>" TABINDEX="13">&nbsp;（例）03-5776-2688
					</td>
					</tr>
<?php
	if($e_tel_msg){
...
?>
					...
					FAX番号</td>
					<td width="530" class="tb2" bgcolor="#ffffff">
					<input type="text" name="e_fax" style="width:300px" value="<?=$e_fax?>" TABINDEX="14">&nbsp;（例）03-1234-5678
					</td>
					</tr>
<?php
	if($e_fax_msg){
...
?>
					...
					生年月日<span class="style7">※</span></td>
					<td width="530" class="tb2" bgcolor="#ffffff">
					<input type="text" name="e_birthday" style="width:300px" value="<?=$e_birthday?>" TABINDEX="15">&nbsp;（例）1980/01/01
					</td>
					</tr>
<?php
	if($e_birthday_msg){
