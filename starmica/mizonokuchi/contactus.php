...
<meta name="Keywords" content="ステラガーデン溝ノ口,東急田園都市線,溝ノ口駅,マンション,中古マンション,分譲マンション" />
<meta name="Description" content="ステラガーデン溝ノ口は、東急田園都市線「溝ノ口」駅徒歩10分。緑に囲まれた高台に誕生するリノベーションマンション｜中古マンション購入の相談なら、スター・マイカ・レジデンスへ" />
<title>資料請求｜ステラガーデン溝ノ口</title>
...
<div id="header">
  <div class="clear-box">
        ...
        <div class="right">
          <ul id="mini-navi">
		<li><a href="http://www.starmica-r.co.jp/mizonokuchi/chizu.php"><img src="img/mini-navi_1.gif" alt="現地案内図" width="92" height="14" /></a></li>
...
<div id="top" class="page1">
	<div id="wrapper">
		<div id="title-area">
			<div id="globalnavi-s">
				   <ul>
				    <li><a href="http://www.starmica-r.co.jp/mizonokuchi/concept.php"><img src="img/globalnavi_1.gif" alt="コンセプト" /></a></li>
				    <li><a href="http://www.starmica-r.co.jp/mizonokuchi/masterplan.php"><img src="img/globalnavi_2.gif" alt="全体計画" /></a></li>
				    <li><a href="http://www.starmica-r.co.jp/mizonokuchi/location.php"><img src="img/globalnavi_3.gif" alt="溝ノ口エリア" /></a></li>
				    <li><a href="http://www.starmica-r.co.jp/mizonokuchi/plan.php"><img src="img/globalnavi_4.gif" alt="プラン" /></a></li>
				    <li><a href="http://www.starmica-r.co.jp/mizonokuchi/equipment.php"><img src="img/globalnavi_5.gif" alt="構造・設備仕様" /></a></li>
				    <li><a href="http://www.starmica-r.co.jp/mizonokuchi/access.php"><img src="img/globalnavi_6.gif" alt="アクセス" /></a></li>
				    <li><a href="http://www.starmica-r.co.jp/mizonokuchi/outline.php"><img src="img/globalnavi_7.gif" alt="物件概要" /></a></li>
		...
		<div id="bread-crumb">
			<ul>
			<li><a href="http://www.starmica-r.co.jp/mizonokuchi/index.php">ホーム</a></li>
			<li class="arrow">物件概要</li>
			</ul>
		</div>
		<!--/bread-crumb-->
...
上記「<a href="http://www.starmica-r.co.jp/privacy.php" target="_blank"><b>『個人情報の取り扱い』</b></a>の内容に同意される方は、下記<b> [同意して送信] </b>のボタンをクリックして下さい。</center>
          ...
          <!--/indent-area-->
				...
				<p id="page-top"><a href="#header"><img src="img/base_pagetop.gif" alt="このページの先頭へ" width="130" height="21" /></a></p>
...
<div id="footer">
  <div class="item2">
	    <div class="footer-banner">
	          <ol>
			<li><a href="#" target="_blank"><img src="img/jissekisyoukai.jpg" alt="一棟リノベーション紹介＋実績" width="363" height="75" /></a></li>
			<li><a href="http://www.shiawase.starmica-r.co.jp/"" target="_blank"><img src="img/siawase_logo.jpg" alt="しあわせリノベ研究所" width="317" height="75" /></a></li>
			<li><a href="http://www.starmica-r.co.jp/" target="_blank"><img src="img/re_logo.jpg" alt="しあわせリノベ研究所" width="280" height="75" /></a></li>
	           </ol>
	    </div>
	    <!--footer-banner-->
	    <div class="clear-box">
	    <ul>
	         <li class="first"><a href="http://www.starmica-r.co.jp/mizonokuchi/index.php">ホーム</a></li>
	        <li><a href="http://www.starmica-r.co.jp/mizonokuchi/chizu.php">現地案内図</a></li>
...
elseif($errmsg !=1 AND $_POST['sendgo']){
	...
	$oubosubject = "ステラガーデン溝ノ口ＨＰよりお問い合わせ";
	$oubomessage = <<<_EOT_
...
?>
					...
					メールアドレス<span class="style7">※</span></td>
					<td width="530" class="tb2">
					<input type="text" name="e_mail" style="width:300px; ime-mode:disabled" value="<?=$e_mail?>" TABINDEX="9">&nbsp;（例）smr@starmica.co.jp
					</td>
					</tr>
<?php
	if($e_mail_msg){
...
?>
					...
					<td width="530" class="tb2">
					<input type="text" name="e_mail2" style="width:300px; ime-mode:disabled" value="<?=$e_mail2?>" TABINDEX="10">&nbsp;（例）smr@starmica.co.jp
					</td>
					</tr>
<?php
	if($e_mail2_msg){
...
<div id="footer">
  <div class="item2">
	    <div class="footer-banner">
	          <ol>
			<li><a href="http://www.starmica-r.co.jp/mizonokuchi/itou.php"><img src="img/jissekisyoukai.jpg" alt="一棟リノベーション紹介＋実績" width="363" height="75" /></a></li>
			<li><a href="http://www.shiawase.starmica-r.co.jp/"" target="_blank"><img src="img/siawase_logo.jpg" alt="しあわせリノベ研究所" width="317" height="75" /></a></li>
			<li><a href="http://www.starmica-r.co.jp/" target="_blank"><img src="img/re_logo.jpg" alt="しあわせリノベ研究所" width="280" height="75" /></a></li>
	           </ol>
	    </div>
