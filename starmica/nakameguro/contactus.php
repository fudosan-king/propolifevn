...
<div id="header">
  <div class="clear-box">
        <div class="left">
    		<h1><a href="http://www.starmica-r.co.jp/nakameguro/index.php"><img src="img/header_logo.gif" alt="ステラレジデンス中目黒は、東京メトロ日比谷線「中目黒」駅徒歩9分、東急田園都市線「池尻大橋」駅徒歩13分のマンションです。" width="356" height="66" /></a></h1>
	</div>
        <div class="right">
          <ul id="mini-navi">
		<li><a href="http://www.starmica-r.co.jp/nakameguro/location.php#map"><img src="img/mininavi_1.gif" alt="現地案内図" width="80" height="16" /></a></li>
...
<div id="globalnavi">
   <ul>
    <li><a href="http://www.starmica-r.co.jp/nakameguro/index.php"><img src="img/globalnavi_1.gif" alt="ホーム" width="150" height="44" /></a></li>
    <li><a href="http://www.starmica-r.co.jp/nakameguro/location.php"><img src="img/globalnavi_2.gif" alt="周辺環境" width="150" height="44" /></a></li>
    <li><a href="http://www.starmica-r.co.jp/nakameguro/plan.php"><img src="img/globalnavi_3.gif" alt="間取り" width="150" height="44" /></a></li>
    <li><a href="http://www.starmica-r.co.jp/nakameguro/access.php"><img src="img/globalnavi_4.gif" alt="アクセス" width="150" height="44" /></a></li>
    <li><a href="http://www.starmica-r.co.jp/nakameguro/gaiyou.php"><img src="img/globalnavi_5.gif" alt="物件概要" width="150" height="44" /></a></li>
    <li><a href="https://www.starmica-r.co.jp/nakameguro/contactus.php"><img src="img/globalnavi_6_on.gif" alt="お問い合わせ・資料請求" width="150" height="44" /></a></li>
   </ul>
</div>
<!--/globalnavi-->
<hr />
<div id="bukken" class="page1">
  <div id="wrapper">
    <div id="title-area900">
      <div id="bread-crumb">
        <ul>
          <li><a href="http://www.starmica-r.co.jp/nakameguro/index.php">ホーム</a></li>
    ...
    <!--/title-area-->
    <div id="container900">
	<div class="title"><img src="img/contact_title.gif" alt="お問い合わせ" width="266" height="66" /></div>
...
?>
					...
					<tr> 
					<td width="340" class="tb2-b">
					何をご覧頂いて<br>当HPをお知りになりましたか？<span class="style7">※</span></td>
					<td width="530" class="tb2">
<?php
	if($e_kikkake == 1){
		print"YAHOO！不動産";
...
<div id="footer">
  <div class="item2">
  	<div class="item3">
	    <div class="clear-box">
	    <ul>
	        <li class="first"><a href="http://www.starmica-r.co.jp/nakameguro/index.php">ホーム</a></li>
	        <li><a href="http://www.starmica-r.co.jp/nakameguro/location.php#map">現地案内図</a></li>
	        <li><a href="http://www.starmica-r.co.jp/nakameguro/gaiyou.php">物件概要</a></li>
...
elseif($errmsg !=1 AND $_POST['sendgo']){
	...
	$oubosubject = "ステラレジデンス中目黒ＨＰよりお問い合わせ";
	$oubomessage = <<<_EOT_
