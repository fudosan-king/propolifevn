...
<div class="sec2">
    <div class="bukken700">
            <div class="item-title">
              <h5><img src="img/madori-title302.gif" alt="302号室　1LDK　4,380万円" width="700" height="38" /></h5>
            </div>
            <!--/item-title-->

		<div class="dai-photowaku">
			<img src="img/madori_302.png" alt="間取り図" width="700" height="585" />
		</div>
		<div class="outline">
			&nbsp&nbsp■管理費 20,100円/月&nbsp; &nbsp;■修繕積立金 10,300円/月&nbsp; &nbsp;■所在階 3階
		</div>
		<br>
       </div>
       <!--/bukken700-->
