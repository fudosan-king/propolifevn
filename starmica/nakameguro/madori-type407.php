...
<div id="header2">
  <div class="clear-box">
        <div class="left">
    		<h1><a href="index.php"><img src="img/header_logo.gif" alt="ステラレジデンス中目黒" width="356" height="66" /></a></h1>
	</div>
        <div class="right">
          <ul id="mini-navi">
...
<div class="sec2">
    <div class="bukken700">
            <div class="item-title">
              <h5><img src="img/madori-title407.gif" alt="407号室　1LDK　4,030万円" width="700" height="38" /></h5>
            </div>
            <!--/item-title-->

		<div class="dai-photowaku">
			<img src="img/madori_202.gif" alt="間取り図" width="700" height="585" />
		</div>
		<div class="outline">
			&nbsp&nbsp■管理費 20,100円/月&nbsp; &nbsp;■修繕積立金 10,300円/月&nbsp; &nbsp;■所在階 4階
		</div>
		<br>
       </div>
       <!--/bukken700-->
	...
	<center>
		<table>
		<tr><td><a href="https://www.starmica-r.co.jp/nakameguro/contactus.php" target="_blank"><img src="img/otoiawase_dai.gif" alt="お問い合わせ・資料請求はこちら" width="267" height="54" /></a></td>
		<td width="15">&nbsp;</td>
