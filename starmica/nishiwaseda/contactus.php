...
<div id="header">
  <div class="clear-box">
        <div class="left">
    		<h1><a href="http://www.starmica-r.co.jp/nishiwaseda/index.php"><img src="img/header_logo.gif" alt="ニューライフ西早稲田" width="303" height="77" /></a></h1>
	</div>
        <div class="right">
          <ul id="mini-navi">
		<li><a href="http://www.starmica-r.co.jp/nishiwaseda/access.php#a2"><img src="img/mininavi_1.gif" alt="現地案内図" width="97" height="16" /></a></li>
...
<div id="globalnavi">
   <ul>
    <li><a href="http://www.starmica-r.co.jp/nishiwaseda/index.php"><img src="img/globalnavi_1.gif" alt="ホーム" width="150" height="40" /></a></li>
    <li><a href="http://www.starmica-r.co.jp/nishiwaseda/concept.php"><img src="img/globalnavi_2.gif" alt="コンセプト" width="150" height="40" /></a></li>
    <li><a href="http://www.starmica-r.co.jp/nishiwaseda/syuhen.php"><img src="img/globalnavi_3.gif" alt="周辺環境" width="150" height="40" /></a></li>
    <li><a href="http://www.starmica-r.co.jp/nishiwaseda/madori.php"><img src="img/globalnavi_4.gif" alt="間取り" width="150" height="40" /></a></li>
    <li><a href="http://www.starmica-r.co.jp/nishiwaseda/access.php"><img src="img/globalnavi_5.gif" alt="アクセス" width="150" height="40" /></a></li>
    <li><a href="http://www.starmica-r.co.jp/nishiwaseda/gaiyou.php"><img src="img/globalnavi_6.gif" alt="物件概要" width="150" height="40" /></a></li>
   </ul>
</div>
<!--/globalnavi-->
<hr />
<div id="bukken" class="page1">
  <div id="wrapper">
    <div id="title-area900">
      <div id="bread-crumb">
        <ul>
          <li><a href="http://www.starmica-r.co.jp/nishiwaseda/index.php">ホーム</a></li>
    ...
    <!--/title-area-->
    <div id="container900">
      <h2><img src="img/contactus_title.gif" alt="お問い合わせ" width="900" height="70" /></h2>
      <div id="content900">
...
<div id="footer">
  <div class="item2">
	    <div class="clear-box">
	    <ul>
	         <li class="first"><a href="http://www.starmica-r.co.jp/nishiwaseda/index.php">ホーム</a></li>
	        <li><a href="http://www.starmica-r.co.jp/nishiwaseda/access.php">現地案内図</a></li>
	        <li><a href="http://www.starmica-r.co.jp/nishiwaseda/gaiyou.php">物件概要</a></li>
...
elseif($errmsg !=1 AND $_POST['sendgo']){
	...
	$oubosubject = "ニューライフ西早稲田ＨＰよりお問い合わせ";
	$oubomessage = <<<_EOT_
