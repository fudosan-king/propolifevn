...
<div class="sec2">
    <div class="bukken700">
            <div class="item-title">
              <h5>2,440万円　2LDK　45.75㎡　バルコニー面積 不明</h5>
            </div>
            <!--/item-title-->
		<p class="top-5">
			新規フルリフォーム済物件！！
		...
		<div class="dai-photowaku">
			<img src="img/madori_1302.jpg" alt="間取り" width="630" height="600" />
		</div>
		<p class="top-5">
			●13階建て13階部分　●管理費/月額7,900円  ●修繕積立金/月額4,990円　●ペット飼育/可(管理規約に基づく)
		</p>
...
<br>
		...
		<table>
			<tr>
			<td><a href="contactus.php" target="_blank"><img src="img/otoiawase_dai.gif" alt="お問い合わせ・資料請求はこちら" width="267" height="54" /></a></td>
			<td width="15">&nbsp;</td>
