...
<div class="sec2">
    <div class="bukken700">
            <div class="item-title">
              <h5>2,450万円　2LDK　47.15㎡　バルコニー面積 不明</h5>
            </div>
            <!--/item-title-->
		<p class="top-5">
			アフターサービス保証付き！リフォーム済み！
		</p>
		<div class="dai-photowaku">
			<img src="img/madori_1003.jpg" alt="間取り" width="630" height="600" />
		</div>
		<p class="top-5">
			●13階建て10階部分　●管理費/月額8,140円  ●修繕積立金/月額5,150円　●ペット飼育/可(管理規約に基づく)
		</p>
<br>
        <div class="bottom-20">
	<center>
