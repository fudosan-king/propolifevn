...
<meta name="Keywords" content="ステラスイート大井,マンション,中古マンション,購入" />
<meta name="Description" content="大井町駅周辺の「ステラスイート大井」のマンション購入に関する相談なら、スター・マイカ・レジデンス株式会社" />
...
<div id="header">
  <div class="clear-box">
        <div class="left">
<h3>ステラスイート大井は、JR京浜東北線・東急大井町線・りんかい線 大井駅、JR横須賀線 西大井駅 4路線2駅利用可</h3>
    <h1><a href="http://www.starmica-r.co.jp/ooi/index.php"><img src="img/base_logo.gif" alt="ステラスイート大井 ｜マンション購入のことなら、スター・マイカ・レジデンス株式会社" width="252" height="27" /></a></h1>
	</div>	
        <div class="right">
          <ul id="mini-navi">
		<li><a href="http://www.starmica-r.co.jp/ooi/access.php#a2"><img src="img/mini-navi_1_off.gif" alt="現地案内図" width="68" height="13" /></a></li>
		<li><a href="http://www.starmica-r.co.jp/ooi/gaiyou.php"><img src="img/mini-navi_2_off.gif" alt="物件概要" width="56" height="13" /></a></li>
		<li><a href="http://www.starmica-r.co.jp/corprateprofile.php" target="_blank"><img src="img/mini-navi_3_off.gif" alt="会社情報" width="56" height="13" /></a></li>
          ...
          <div class="phone"><a href="https://www.starmica-r.co.jp/ooi/contactus.php"><img src="img/toiawase.gif" alt="お問い合わせ・資料請求" width="189" height="30" /></a></div>
        </div>
...
<?php
	if($currentmenu == '1'){
?>
    <li><a href="http://www.starmica-r.co.jp/ooi/index.php"><img src="img/globalnavi_1_on.gif" alt="ホーム" width="182" height="40" /></a></li>
<?php
	}
	else{
?>
    <li><a href="http://www.starmica-r.co.jp/ooi/index.php"><img src="img/globalnavi_1.gif" alt="ホーム" width="182" height="40" /></a></li>
<?php
	}
	if($currentmenu == '2'){
?>
    <li><a href="http://www.starmica-r.co.jp/ooi/madori.php"><img src="img/globalnavi_2_on.gif" alt="間取りプラン" width="179" height="40" /></a></li>
<?php
	}
	else{
?>
    <li><a href="http://www.starmica-r.co.jp/ooi/madori.php"><img src="img/globalnavi_2.gif" alt="間取りプラン" width="179" height="40" /></a></li>
<?php
	}
	if($currentmenu == '3'){
?>
    <li><a href="http://www.starmica-r.co.jp/ooi/syuhen.php"><img src="img/globalnavi_3_on.gif" alt="周辺環境" width="179" height="40" /></a></li>
<?php
	}
	else{
?>
    <li><a href="http://www.starmica-r.co.jp/ooi/syuhen.php"><img src="img/globalnavi_3.gif" alt="周辺環境" width="179" height="40" /></a></li>
<?php
	}
	if($currentmenu == '4'){
?>      
    <li><a href="http://www.starmica-r.co.jp/ooi/access.php"><img src="img/globalnavi_4_on.gif" alt="アクセス" width="179" height="40" /></a></li>
<?php
	}
	else{
?>
    <li><a href="http://www.starmica-r.co.jp/ooi/access.php"><img src="img/globalnavi_4.gif" alt="アクセス" width="179" height="40" /></a></li>
<?php
	}
	if($currentmenu == '5'){
?> 
    <li><a href="http://www.starmica-r.co.jp/ooi/shisetu.php"><img src="img/globalnavi_5_on.gif" alt="共用施設" width="181" height="40" /></a></li>
<?php
	}
	else{
?>
    <li><a href="http://www.starmica-r.co.jp/ooi/shisetu.php"><img src="img/globalnavi_5.gif" alt="共用施設" width="181" height="40" /></a></li>
<?php
	}
?> 
      </ul>
...
<div id="bukken" class="page1">
  <div id="wrapper">
    <div id="title-area900">
      ...
      <div id="bread-crumb">
        <ul>
          <li><a href="http://www.starmica-r.co.jp/ooi/index.php">ホーム</a></li>
...
<div id="footer">
  <div class="item2">
    <div class="clear-box">
    <ul>
         <li class="first"><a href="http://www.starmica-r.co.jp/ooi/index.php">ホーム</a></li>
        <li><a href="http://www.starmica-r.co.jp/ooi/access.php#a2">現地案内図</a></li>
        <li><a href="http://www.starmica-r.co.jp/ooi/gaiyou.php">物件概要</a></li>
        <li><a href="http://www.starmica-r.co.jp/privacy.php" target="_blank">個人情報保護方針</a></li>
        <li><a href="https://www.starmica-r.co.jp/ooi/contactus.php">お問い合わせ</a></li>
        <li></li>
<br>
<a href="https://www.starmica-r.co.jp/ooi/contactus.php" target="_blank"><img src="img/fan_base_logo.gif" alt="フリーダイヤル" width="335" height="42" /></a>
    </ul>
    <p class="copy">
<a href="https://www.starmica-r.co.jp/ooi/contactus.php"><img src="img/feetel.gif" alt="フリーダイヤル" width="331" height="59" /></a>
</p>
    </div>
    <!--clear-box-->
  </div>
...
elseif($errmsg !=1 AND $_POST['sendgo']){
	...
	$oubosubject = "ステラスイート大井ＨＰよりお問い合わせ";
	$oubomessage = <<<_EOT_
...
?>
					...
					メールアドレス<span class="style7">※</span></td>
					<td width="530" class="tb2">
					<input type="text" name="e_mail" style="width:300px; ime-mode:disabled" value="<?=$e_mail?>" TABINDEX="9">&nbsp;（例）smr@starmica-r.co.jp
					</td>
					</tr>
<?php
	if($e_mail_msg){
...
?>
					...
					<td width="530" class="tb2">
					<input type="text" name="e_mail2" style="width:300px; ime-mode:disabled" value="<?=$e_mail2?>" TABINDEX="10">&nbsp;（例）smr@starmica-r.co.jp
					</td>
					</tr>
<?php
	if($e_mail2_msg){
