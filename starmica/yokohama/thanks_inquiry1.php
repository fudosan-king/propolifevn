...
$HTMLTITLE ="資料請求・お問い合わせ｜ステラレジデンス横浜｜リノベーションマンション、中古マンションの購入ならスター・マイカ・レジデンス株式会社";
$currentmenu = 0;
...
<div id="bukken" class="page1">
  <div id="wrapper">
	...
	<div class="title"><img src="img/pagetitle7.png" alt="お問い合わせ" width="163" height="163" /></div>
      ...
      <div id="content900">
          <div class="top-20"><center><span class="style8">資料請求・お問い合わせいただきありがとうございます。</span></center></div>
        <div class="sec1 bottom-20">
          	<div class="top-10">
				<center>資料請求・お問い合わせいただき、誠にありがとうございました。
				後程、担当者よりご連絡させていただきます。<br>
				営業時間内でのご連絡となります。<br>（営業時間は9:30～18:30、休業日は火・水曜日となります。）</center>
