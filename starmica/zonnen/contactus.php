...
<meta name="Description" content="王子駅近く「ゾンネンハイム元住吉」マンション購入なら、スター・マイカ・レジデンス株式会社" />
<title>ゾンネンハイム元住吉｜中古マンション購入ならファン･インベストメント株式会社</title>
...
<div id="header">
  <div class="clear-box">
    <h1><a href="http://www.starmica-r.co.jp/zonnen/index.html"><img src="img/base_logo.gif" alt="ゾンネンハイム元住吉 ｜中古マンション購入なら、スター・マイカ・レジデンス株式会社" width="285" height="59" /></a></h1>
        <div class="right">
          <ul id="mini-navi">
		<li><a href="http://www.starmica-r.co.jp/zonnen/access.html#a2"><img src="img/mini-navi_1_off.gif" alt="現地案内図" width="68" height="13" /></a></li>
		<li><a href="http://www.starmica-r.co.jp/zonnen/gaiyou.html"><img src="img/mini-navi_3_off.gif" alt="物件概要" width="56" height="13" /></a></li>
		<li><a href="http://www.fan-invest.co.jp/aboutus.html" target="_blank"><img src="img/mini-navi_2_off.gif" alt="会社情報" width="56" height="13" /></a></li>
          </ul>
          <div class="phone"><a href="https://www.starmica-r.co.jp/zonnen/contactus.php"><img src="img/base_btn_contact.jpg" alt="お問い合わせ・資料請求" width="189" height="30" /></a></div>
        </div>
...
<div id="globalnavi">
  <ul>
    <li><a href="http://www.starmica-r.co.jp/zonnen/index.html"><img src="img/globalnavi_1.gif" alt="ホーム" width="182" height="40" /></a></li>
    <li><a href="http://www.starmica-r.co.jp/zonnen/madori.html"><img src="img/globalnavi_2.gif" alt="間取り" width="179" height="40" /></a></li>
    <li><a href="http://www.starmica-r.co.jp/zonnen/syuhen.html"><img src="img/globalnavi_3.gif" alt="周辺環境" width="179" height="40" /></a></li>
    <li><a href="http://www.starmica-r.co.jp/zonnen/access.html"><img src="img/globalnavi_4.gif" alt="アクセス" width="181" height="40" /></a></li>
    <li><a href="http://www.starmica-r.co.jp/zonnen/gaiyou.html"><img src="img/globalnavi_5.gif" alt="物件概要" width="179" height="40" /></a></li>
  </ul>
</div>
<!--/globalnavi-->
<hr />
<div id="bukken" class="page1">
  <div id="wrapper">
    <div id="title-area900">
      <h2><img src="img/toiawase_title.jpg" alt="ゾンネンハイム元住吉 お問い合わせ・資料請求" width="900" height="140" /></h2>
      <div id="bread-crumb">
        <ul>
          <li><a href="http://www.starmica-r.co.jp/zonnen/index.html">ホーム</a></li>
...
<div id="footer">
  <div class="item2">
    <div class="clear-box">
    <ul>
        <li class="first"><a href="http://www.starmica-r.co.jp/zonnen/index.html">ホーム</a></li>
        <li><a href="http://www.starmica-r.co.jp/zonnen/access.html#a2">現地案内図</a></li>
        <li><a href="http://www.starmica-r.co.jp/zonnen/gaiyou.html">物件概要</a></li>
        <li><a href="http://www.starmica-r.co.jp/privacy.php" target="_blank">個人情報保護方針</a></li>
        <li><a href="https://www.starmica-r.co.jp/zonnen/contactus.php">お問い合わせ</a></li>
    </ul>
...
elseif($errmsg !=1 AND $_POST['sendgo']){
	...
	$oubosubject = "ゾンネンハイム元住吉ＨＰよりお問い合わせ";
	$oubomessage = <<<_EOT_
...
<head>
<meta http-equiv="Content-Type" content="text/html; charset=EUC-JP"/>
<meta name="Keywords" content="マンション,中古マンション,購入" />
<meta name="Description" content="ゾンネンハイム元住吉マンション購入なら、スター・マイカ・レジデンス株式会社" />
<title>お問い合わせ・資料請求｜ゾンネンハイム元住吉イーストコート｜中古マンション購入ならファン･インベストメント株式会社</title>
<link rel="stylesheet" type="text/css" media="all" href="css/import.css" />
<meta http-equiv="Content-Script-Type" content="text/javascript" />
<script type="text/javascript" src="js/jquery-1.3.2.min.js"></script>
<script type="text/javascript" src="js/smoothscroll.js"></script>
...
<div id="header">
  <div class="clear-box">
    <h1><a href="http://www.starmica-r.co.jp/zonnen/index.html"><img src="img/base_logo.gif" alt="ゾンネンハイム元住吉 ｜中古マンション購入なら、スター・マイカ・レジデンス株式会社" width="285" height="59" /></a></h1>
		...
		<li><a href="http://www.starmica-r.co.jp/zonnen/access.html#a2"><img src="img/mini-navi_1_off.gif" alt="現地案内図" width="68" height="13" /></a></li>
		<li><a href="http://www.starmica-r.co.jp/zonnen/gaiyou.html"><img src="img/mini-navi_3_off.gif" alt="物件概要" width="56" height="13" /></a></li>
		<li><a href="http://www.starmica-r.co.jp/corprateprofile.php" target="_blank"><img src="img/mini-navi_2_off.gif" alt="会社情報" width="56" height="13" /></a></li>
          </ul>
          <div class="phone"><a href="https://www.starmica-r.co.jp/zonnen/contactus.php"><img src="img/base_btn_contact.jpg" alt="お問い合わせ・資料請求" width="189" height="30" /></a></div>
        </div>
